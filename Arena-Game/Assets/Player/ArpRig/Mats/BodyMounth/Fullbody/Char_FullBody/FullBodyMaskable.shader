...
Shader "FullBodyMaskable"
{
	Properties
	{
		...
		_AlphaClipThres("AlphaClipThres", Range( 0 , 1)) = 0.5
		_HelmMask("HelmMask", 2D) = "black" {}
		_ChestMask("ChestMask", 2D) = "black" {}
		_GauntletsMask("GauntletsMask", 2D) = "black" {}
		[ASEEnd]_LeggingMask("LeggingMask", 2D) = "black" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Normal_ST;
			float4 _HelmMask_ST;
			float4 _ChestMask_ST;
			float4 _GauntletsMask_ST;
			float4 _LeggingMask_ST;
			float _Metallicness;
			float _Smoothness;
			float _AlphaClipThres;
			...
			sampler2D _Normal;
			sampler2D _HelmMask;
			sampler2D _ChestMask;
			sampler2D _GauntletsMask;
			sampler2D _LeggingMask;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_HelmMask = IN.ase_texcoord8.xy * _HelmMask_ST.xy + _HelmMask_ST.zw;
				float2 uv_ChestMask = IN.ase_texcoord8.xy * _ChestMask_ST.xy + _ChestMask_ST.zw;
				float2 uv_GauntletsMask = IN.ase_texcoord8.xy * _GauntletsMask_ST.xy + _GauntletsMask_ST.zw;
				float2 uv_LeggingMask = IN.ase_texcoord8.xy * _LeggingMask_ST.xy + _LeggingMask_ST.zw;
				
				float3 Albedo = tex2D( _Albedo, uv_Albedo ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = _Metallicness;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float Alpha = ( 1.0 - saturate( ( tex2D( _HelmMask, uv_HelmMask ).r + tex2D( _ChestMask, uv_ChestMask ).r + tex2D( _GauntletsMask, uv_GauntletsMask ).r + tex2D( _LeggingMask, uv_LeggingMask ).r ) ) );
				float AlphaClipThreshold = _AlphaClipThres;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_HelmMask = IN.ase_texcoord2.xy * _HelmMask_ST.xy + _HelmMask_ST.zw;
				float2 uv_ChestMask = IN.ase_texcoord2.xy * _ChestMask_ST.xy + _ChestMask_ST.zw;
				float2 uv_GauntletsMask = IN.ase_texcoord2.xy * _GauntletsMask_ST.xy + _GauntletsMask_ST.zw;
				float2 uv_LeggingMask = IN.ase_texcoord2.xy * _LeggingMask_ST.xy + _LeggingMask_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_HelmMask = IN.ase_texcoord4.xy * _HelmMask_ST.xy + _HelmMask_ST.zw;
				float2 uv_ChestMask = IN.ase_texcoord4.xy * _ChestMask_ST.xy + _ChestMask_ST.zw;
				float2 uv_GauntletsMask = IN.ase_texcoord4.xy * _GauntletsMask_ST.xy + _GauntletsMask_ST.zw;
				float2 uv_LeggingMask = IN.ase_texcoord4.xy * _LeggingMask_ST.xy + _LeggingMask_ST.zw;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_HelmMask = IN.ase_texcoord.xy * _HelmMask_ST.xy + _HelmMask_ST.zw;
				float2 uv_ChestMask = IN.ase_texcoord.xy * _ChestMask_ST.xy + _ChestMask_ST.zw;
				float2 uv_GauntletsMask = IN.ase_texcoord.xy * _GauntletsMask_ST.xy + _GauntletsMask_ST.zw;
				float2 uv_LeggingMask = IN.ase_texcoord.xy * _LeggingMask_ST.xy + _LeggingMask_ST.zw;
				
				surfaceDescription.Alpha = ( 1.0 - saturate( ( tex2D( _HelmMask, uv_HelmMask ).r + tex2D( _ChestMask, uv_ChestMask ).r + tex2D( _GauntletsMask, uv_GauntletsMask ).r + tex2D( _LeggingMask, uv_LeggingMask ).r ) ) );
				surfaceDescription.AlphaClipThreshold = _AlphaClipThres;
...
/*ASEBEGIN
Version=18935
271;73;958;579;1520.559;-637.9619;1.3;True;False
Node;AmplifyShaderEditor.SamplerNode;17;-1006.658,603.7927;Inherit;True;Property;_HelmMask;HelmMask;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;20;-999.1023,813.8229;Inherit;True;Property;_ChestMask;ChestMask;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;22;-996.6025,1015.323;Inherit;True;Property;_GauntletsMask;GauntletsMask;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-997.6025,1234.323;Inherit;True;Property;_LeggingMask;LeggingMask;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-567.9733,939.2648;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;26;-419.7355,849.763;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-892.9852,378.5453;Inherit;False;Property;_Metallicness;Metallicness;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-916.9852,177.5453;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-49.27539,400.7927;Inherit;False;Property;_AlphaClipThres;AlphaClipThres;4;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;27;-272.7231,442.7407;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-911.9852,-37.45465;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-888.9852,459.5453;Inherit;False;Property;_Smoothness;Smoothness;2;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;199,5;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;FullBodyMaskable;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=1DFFBECF336E81FDDE8C17DFE3CAF6FC4AE52A19