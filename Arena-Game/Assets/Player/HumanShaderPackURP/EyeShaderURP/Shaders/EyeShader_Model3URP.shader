	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord264 = IN.ase_texcoord8.yz * temp_cast_5 + temp_cast_6;
				...
				float lerpResult536 = lerp( _PupilSize , ( _PupilSize + ( ( ( ( ( break690.x + break690.y + break690.z ) / 3.0 ) * temp_output_6_0_g24 ) * IrisPupil_MASK585 ) * _PupilAutoDilateFactor ) ) , _PupilAffectedByLight_Amount);
				...
				float2 texCoord190 = IN.ase_texcoord8.yz * temp_cast_9 + ( ( ParallaxPush_Vec2580 * float2( 0.15,0.15 ) ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) );
				...
				float dotResult6_g40 = dot( float4( normalizedWorldNormal , 0.0 ) , transform3_g40 );
				float clampResult7_g40 = clamp( dotResult6_g40 , 0.0 , 1.0 );
				float4 transform2_g40 = mul(GetObjectToWorldMatrix(),float4( 0,1.2,1,0.78 ));
				float dotResult5_g40 = dot( float4( normalizedWorldNormal , 0.0 ) , transform2_g40 );
				float clampResult8_g40 = clamp( dotResult5_g40 , 0.0 , 1.0 );
				float temp_output_17_0_g40 = 0.0;
				float3 temp_cast_12 = (pow( ( clampResult7_g40 * clampResult8_g40 ) , temp_output_17_0_g40 )).xxx;
				...
				float2 texCoord3_g53 = IN.ase_texcoord8.yz * temp_cast_17 + float2( 0,0 );
				float simplePerlin3D4_g53 = snoise( float3( texCoord3_g53 ,  0.0 ) );
				...
				float2 texCoord409 = IN.ase_texcoord8.yz * float2( 0,0 ) + paralaxOffset411;
				...
				float3 BaseColor = temp_output_803_0.rgb;
				float3 Normal = NORMAL_OUTPUT640;
				float3 Emission = ( lerpResult865 * _Final_Illumination_Power ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_5 = (_EyeSize).xx;
				float2 temp_cast_6 = (( ( 1.0 - _EyeSize ) / 2.0 )).xx;
				float2 texCoord264 = IN.ase_texcoord5.xy * temp_cast_5 + temp_cast_6;
				float2 eyeSizeUVs604 = texCoord264;
				float4 tex2DNode166 = tex2D( _RGBMask, eyeSizeUVs604 );
				float lerpResult706 = lerp( tex2DNode166.b , ( tex2DNode166.b - tex2DNode166.r ) , _LimbalEdge_Adjustment);
				float clampResult721 = clamp( lerpResult706 , 0.0 , 1.0 );
				...
				float eyeSizing616 = ( _IrisSize + _EyeSize + IrisPupilFactor577 );
				float2 temp_cast_9 = (eyeSizing616).xx;
				float2 texCoord190 = IN.ase_texcoord5.xy * temp_cast_9 + ( ( ParallaxPush_Vec2580 * float2( 0.15,0.15 ) ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) );
				float mulTime765 = _TimeParameters.x * _IrisRotationAnimation;
				float cos764 = cos( mulTime765 );
				float sin764 = sin( mulTime765 );
				float2 rotator764 = mul( texCoord190 - float2( 0.5,0.5 ) , float2x2( cos764 , -sin764 , sin764 , cos764 )) + float2( 0.5,0.5 );
				...
				float2 paralaxOffset411 = ParallaxOffset( tex2DNode416.r , ( PupilParallaxHeight574 * 0.03 ) , ase_tanViewDir );
				float2 texCoord409 = IN.ase_texcoord5.xy * float2( 0,0 ) + paralaxOffset411;
				float2 ParallaxOffset_Vec2583 = texCoord409;
				float2 eyeLocalUV633 = ( eyeSizeUVs604 + ParallaxOffset_Vec2583 );
				float cos373 = cos( SafeNormalize(_MainLightPosition.xyz).x );
				float sin373 = sin( SafeNormalize(_MainLightPosition.xyz).x );
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3461.919,-655.2391;Float;False;Property;_EyeSize;EyeSize;12;0;Create;True;0;0;0;False;0;False;1;0.94;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;707;-2990.846,75.49301;Float;False;Property;_LimbalEdge_Adjustment;LimbalEdge_Adjustment;9;0;Create;True;0;0;0;False;0;False;0;0.633;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;543;-5604.761,-1418.477;Float;False;Property;_PupilAutoDilateFactor;PupilAutoDilateFactor;27;0;Create;True;0;0;0;False;0;False;0;25.1;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-5598.821,-1329.853;Half;False;Property;_PupilSize;PupilSize;24;0;Create;True;0;0;0;False;0;False;70;73.7;0.001;99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;535;-5604.813,-1241.473;Float;False;Property;_PupilAffectedByLight_Amount;PupilAffectedByLight_Amount;28;0;Create;True;0;0;0;False;0;False;0;0.192;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;-3471.69,-774.9874;Float;False;Property;_IrisSize;IrisSize;13;0;Create;True;0;0;0;False;0;False;1;1.98;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-4234.873,-1134.933;Float;False;Property;_PupilWidthHeightRatio;Pupil WidthHeightRatio;25;0;Create;True;0;0;0;False;0;False;1;1;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-3061.348,-1158.257;Float;False;Property;_PupilSharpness;PupilSharpness;26;0;Create;True;0;0;0;False;0;False;5;3.19;0.1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);6;0;Create;True;0;0;0;False;0;False;0.08088237,0.07573904,0.04698314,0.591;0.2186424,0.3806061,0.5188678,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;170;-1908.036,772.9764;Float;False;Property;_EyeVeinColorAmountA;EyeVeinColor-Amount(A);7;0;Create;True;0;0;0;False;0;False;0.375,0,0,0;0.3823529,0.1539494,0.1152681,0.541;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;182;-3417.43,823.6976;Float;False;Property;_RingColorAmount;RingColor-Amount;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3970588,0.3970588,0.3970588,0.353;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;133;-3418.101,633.1917;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);4;0;Create;True;0;0;0;False;2;Header(Color Customization);Space(6);False;1,1,1,0.853;0.6132076,0.5765694,0.5765694,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;126;-706.0718,1582.184;Float;False;Property;_IrisBaseColor;IrisBaseColor;5;0;Create;True;0;0;0;False;0;False;0.4999702,0.5441177,0.4641004,1;0.08632957,0.1412489,0.1886792,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;489;594.1643,1489.961;Float;False;InstancedProperty;_MinimumGlow;MinimumGlow;33;0;Create;True;0;0;0;False;0;False;0.2;0.177;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-1382.126,3177.075;Float;False;Property;_EyeShadingPower;EyeShadingPower;32;0;Create;True;0;0;0;False;0;False;0.5;0.95;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;647;2707.268,1444.284;Float;False;Property;_PupilColorEmissivenessA;PupilColor-Emissiveness(A);23;0;Create;True;0;0;0;False;2;Header(Pupil Control);Space(6);False;0,0,0,0;0.03676468,0.03568337,0.03568337,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;789;3885.831,1021.573;Float;False;Property;_SubSurfaceFromDirectionalLight;SubSurfaceFromDirectionalLight;36;0;Create;True;0;0;0;False;0;False;0.5;0.975;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;875;4170.336,1355.484;Inherit;False;Property;_SkyAmbientControl;SkyAmbientControl;39;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;776;217.8759,859.0576;Float;False;Property;_LimbalRingGloss;LimbalRingGloss;10;0;Create;True;0;0;0;False;0;False;0;0.277;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-753.7518,947.6635;Float;False;Property;_LensGloss;LensGloss;15;0;Create;True;0;0;0;False;0;False;0.98;0.991;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;866;5237.983,2138.433;Inherit;False;Property;_Final_Illumination_Modifier;Final_Illumination_Modifier;37;0;Create;True;0;0;0;False;0;False;0.25;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;864;5348.662,1452.135;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;868;5242.331,2240.898;Inherit;False;Property;_Final_Illumination_Power;Final_Illumination_Power;38;0;Create;True;0;0;0;False;0;False;1;2.47;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;333;586.7011,158.6582;Float;False;Property;_ScleraBumpScale;ScleraBumpScale;11;0;Create;True;0;0;0;False;0;False;0;0.863;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-276.5095,369.9954;Float;False;Property;_LensPush;LensPush;16;0;Create;True;0;0;0;False;0;False;0.64;0.088;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-828.0912,2277.987;Float;False;Property;_CausticPower;CausticPower;21;0;Create;True;0;0;0;False;0;False;10;2.12;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;723;-2128.732,-215.2754;Float;False;Property;_LimbalRingMetalness;LimbalRingMetalness;17;0;Create;True;0;0;0;False;1;Header(Metalness);False;0;0.436;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;499;353.9738,-222.3932;Float;False;Property;_Eyeball_microScatter;Eyeball_microScatter;40;0;Create;True;0;0;0;False;0;False;0;0.54;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Inherit;False;MicroScatterScale_vec2;34;;53;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;759;-858.1108,2447.825;Inherit;False;ConstantBiasScale;-1;;54;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;750;-262.8058,2518.117;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;22;0;Create;True;0;0;0;False;0;False;1;0.36;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;722;-2105.917,-106.2091;Float;False;Property;_EyeBallMetalness;EyeBallMetalness;19;0;Create;True;0;0;0;False;0;False;0;0.102;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;724;-2111.768,155.1683;Float;False;Property;_IrisPupilMetalness;IrisPupilMetalness;18;0;Create;True;0;0;0;False;0;False;0;0.103;0;1;0;1;FLOAT;0
...
WireConnection;849;2;867;0
WireConnection;849;3;664;0
WireConnection;849;4;643;0
ASEEND*/
//CHKSM=A7E54107499D629B8978F4D771B9F55BAC50060A