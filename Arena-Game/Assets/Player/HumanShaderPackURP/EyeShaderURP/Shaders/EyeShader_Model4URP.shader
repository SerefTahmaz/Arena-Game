	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord8.x = ase_vertexTangentSign;
				
				float3 objectSpaceLightDir = mul( GetWorldToObjectMatrix(), _MainLightPosition ).xyz;
				o.ase_texcoord10.xyz = objectSpaceLightDir;
						 ...
						 ) : SV_Target
			{
				...
				float saferPower466 = abs( ( clampResult464 * clampResult465 ) );
				float4 transform3_g150 = mul(GetObjectToWorldMatrix(),float4( 0,-3,1,0.78 ));
				float dotResult6_g150 = dot( float4( normalizedWorldNormal , 0.0 ) , transform3_g150 );
				float clampResult7_g150 = clamp( dotResult6_g150 , 0.0 , 1.0 );
				float4 transform2_g150 = mul(GetObjectToWorldMatrix(),float4( 0,1.2,1,0.78 ));
				float dotResult5_g150 = dot( float4( normalizedWorldNormal , 0.0 ) , transform2_g150 );
				float clampResult8_g150 = clamp( dotResult5_g150 , 0.0 , 1.0 );
				float temp_output_17_0_g150 = _EyeShadingPower;
				float3 temp_cast_4 = (pow( ( clampResult7_g150 * clampResult8_g150 ) , temp_output_17_0_g150 )).xxx;
				float temp_output_12_0_g150 = ( temp_output_17_0_g150 * 0.5 );
				float clampResult18_g150 = clamp( temp_output_12_0_g150 , 0.0 , 0.99 );
				float temp_output_2_0_g151 = clampResult18_g150;
				float temp_output_3_0_g151 = ( 1.0 - temp_output_2_0_g151 );
				float3 appendResult7_g151 = (float3(temp_output_3_0_g151 , temp_output_3_0_g151 , temp_output_3_0_g151));
				float3 temp_output_1168_0 = ( ( temp_cast_4 * temp_output_2_0_g151 ) + appendResult7_g151 );
				float3 temp_cast_6 = (pow( saferPower466 , temp_output_1168_0.x )).xxx;
				float temp_output_2_0_g148 = ( temp_output_1168_0 * float3( 0.5,0,0 ) ).x;
				float temp_output_3_0_g148 = ( 1.0 - temp_output_2_0_g148 );
				float3 appendResult7_g148 = (float3(temp_output_3_0_g148 , temp_output_3_0_g148 , temp_output_3_0_g148));
				float3 eyeShading672 = ( ( temp_cast_6 * temp_output_2_0_g148 ) + appendResult7_g148 );
				float ase_vertexTangentSign = IN.ase_texcoord8.x;
				float3 temp_cast_9 = (ase_vertexTangentSign).xxx;
				float dotResult4_g147 = dot( SafeNormalize(_MainLightPosition.xyz) , temp_cast_9 );
				float temp_output_6_0_g147 = ( dotResult4_g147 - (-1.0 + (_MainLightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) );
				float2 temp_cast_10 = (_EyeSize).xx;
				float2 temp_cast_11 = (( ( 1.0 - _EyeSize ) / 2.0 )).xx;
				float2 texCoord264 = IN.ase_texcoord8.yz * temp_cast_10 + temp_cast_11;
				...
				float lerpResult536 = lerp( _PupilSize , ( _PupilSize + ( ( ( ( _MainLightColor.a / 3.0 ) * temp_output_6_0_g147 ) * IrisPupil_MASK585 ) * _PupilAutoDilateFactor ) ) , _PupilAffectedByLight_Amount);
				...
				float2 uv_ParallaxMask416 = IN.ase_texcoord8.yz;
				...
				float2 texCoord147 = IN.ase_texcoord8.yz * appendResult152.xy + ParallaxPush_Vec2580;
				...
				float2 texCoord190 = IN.ase_texcoord8.yz * temp_cast_13 + ( ( ( ParallaxPush_Vec2580 * ParalaxMaskPower930 ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) ) + ( paralaxOffset411 * ( _IrisParallaxPower * 4.0 ) ) );
				...
				float dotResult5_g149 = dot( SafeNormalize(_MainLightPosition.xyz) , IN.ase_normal );
				float clampResult478 = clamp( ( ( 1.0 * dotResult5_g149 ) * PupilMaskArea625 * _MinimumGlow_Instance ) , _MinimumGlow_Instance , 1.0 );
				float EyeShadePower1124 = _EyeShadingPower;
				float temp_output_17_0_g142 = EyeShadePower1124;
				float temp_output_12_0_g142 = ( temp_output_17_0_g142 * 0.5 );
				float4 transform3_g142 = mul(GetObjectToWorldMatrix(),float4( 0,-3,1,0.78 ));
				float dotResult6_g142 = dot( float4( normalizedWorldNormal , 0.0 ) , transform3_g142 );
				float clampResult7_g142 = clamp( dotResult6_g142 , 0.0 , 1.0 );
				float4 transform2_g142 = mul(GetObjectToWorldMatrix(),float4( 0,1.2,1,0.78 ));
				float dotResult5_g142 = dot( float4( normalizedWorldNormal , 0.0 ) , transform2_g142 );
				float clampResult8_g142 = clamp( dotResult5_g142 , 0.0 , 1.0 );
				float3 temp_cast_17 = (pow( ( clampResult7_g142 * clampResult8_g142 ) , temp_output_17_0_g142 )).xxx;
				float clampResult18_g142 = clamp( temp_output_12_0_g142 , 0.0 , 0.99 );
				float temp_output_2_0_g143 = clampResult18_g142;
				float temp_output_3_0_g143 = ( 1.0 - temp_output_2_0_g143 );
				float3 appendResult7_g143 = (float3(temp_output_3_0_g143 , temp_output_3_0_g143 , temp_output_3_0_g143));
				float4 lerpResult568 = lerp( ( temp_output_326_0 * float4( ( clampResult478 * ( temp_output_12_0_g142 * ( ( temp_cast_17 * temp_output_2_0_g143 ) + appendResult7_g143 ) ) ) , 0.0 ) ) , float4( 0,0,0,0 ) , eyeLimbalRingPower612);
				...
				float temp_output_861_0 = ( 1.0 - dotResult859 );
				...
				float LightDotNorm998 = dotResult859;
				float saferPower993 = abs( LightDotNorm998 );
				...
				float2 texCoord3_g145 = IN.ase_texcoord8.yz * temp_cast_24 + float2( 0,0 );
				float simplePerlin3D4_g145 = snoise( float3( texCoord3_g145 ,  0.0 ) );
				float2 appendResult6_g145 = (float2(simplePerlin3D4_g145 , simplePerlin3D4_g145));
				float4 appendResult572 = (float4(appendResult6_g145 , 1.0 , 0.0));
				...
				float2 texCoord944 = IN.ase_texcoord8.yz * temp_cast_27 + temp_cast_28;
				...
				float3 objectSpaceLightDir = IN.ase_texcoord10.xyz;
				float4 transform1155 = mul(GetWorldToObjectMatrix(),float4( WorldNormal , 0.0 ));
				float fresnelNdotV1143 = dot( normalize( transform1155.xyz ), objectSpaceLightDir );
				...
				float4 temp_cast_31 = (( lerpResult1040 * _MainLightColor.a )).xxxx;
				float4 lerpResult1039 = lerp( temp_cast_31 , temp_output_1045_0 , SSS_Spread954);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float ase_vertexTangentSign = v.ase_tangent.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
				o.ase_texcoord4.w = ase_vertexTangentSign;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 appendResult7_g148 = (float3(temp_output_3_0_g148 , temp_output_3_0_g148 , temp_output_3_0_g148));
				float3 eyeShading672 = ( ( temp_cast_6 * temp_output_2_0_g148 ) + appendResult7_g148 );
				float ase_vertexTangentSign = IN.ase_texcoord4.w;
				float3 temp_cast_9 = (ase_vertexTangentSign).xxx;
				float dotResult4_g147 = dot( SafeNormalize(_MainLightPosition.xyz) , temp_cast_9 );
				float temp_output_6_0_g147 = ( dotResult4_g147 - (-1.0 + (_MainLightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) );
				float2 temp_cast_10 = (_EyeSize).xx;
				float2 temp_cast_11 = (( ( 1.0 - _EyeSize ) / 2.0 )).xx;
				float2 texCoord264 = IN.ase_texcoord5.xy * temp_cast_10 + temp_cast_11;
				float2 eyeSizeUVs604 = texCoord264;
				float4 tex2DNode166 = tex2D( _RGBMask, eyeSizeUVs604 );
				float lerpResult706 = lerp( tex2DNode166.b , ( tex2DNode166.b - tex2DNode166.r ) , _LimbalEdge_Adjustment);
				float clampResult721 = clamp( lerpResult706 , 0.0 , 1.0 );
				...
				float2 appendResult149 = (float2(( temp_output_151_0 / 2.0 ) , ( temp_output_151_0 / ( _PupilHeightWidthRatio * 2.0 ) )));
				float4 appendResult152 = (float4(temp_output_151_0 , ( temp_output_151_0 / _PupilHeightWidthRatio ) , 0.0 , 0.0));
				float2 uv_ParallaxMask416 = IN.ase_texcoord5.xy;
				float4 tex2DNode416 = tex2D( _ParallaxMask, uv_ParallaxMask416 );
				float lerpResult1007 = lerp( tex2DNode416.r , ( 1.0 - tex2DNode416.r ) , _ParallaxMaskInverter);
				float lerpResult418 = lerp( 0.0 , lerpResult1007 , _PushParallaxMask);
				float PupilParallaxHeight574 = _PupilParallaxHeight;
				...
				float2 appendResult927 = (float2(1.0 , (1.0 + (clampResult924 - 1.0) * (0.0 - 1.0) / (10.0 - 1.0))));
				float2 ParallaxPush_Vec2580 = ( paralaxOffset255 * appendResult927 );
				float2 texCoord147 = IN.ase_texcoord5.xy * appendResult152.xy + ParallaxPush_Vec2580;
				float clampResult122 = clamp( ( pow( distance( appendResult149 , texCoord147 ) , ( _PupilSharpness * 7.0 ) ) + ( 1.0 - IrisPupil_MASK585 ) ) , 0.0 , 1.0 );
				float PupilMaskArea625 = clampResult122;
				float Sclera_MASK591 = tex2DNode166.g;
				float clampResult719 = clamp( ( ( _EyeVeinColorAmountA.a * 1.5 ) * Sclera_MASK591 ) , 0.0 , 1.0 );
				...
				float ParalaxMaskPower930 = lerpResult418;
				float2 paralaxOffset411 = ParallaxOffset( tex2DNode416.r , ( PupilParallaxHeight574 * 0.1 ) , ase_tanViewDir );
				float2 texCoord190 = IN.ase_texcoord5.xy * temp_cast_13 + ( ( ( ParallaxPush_Vec2580 * ParalaxMaskPower930 ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) ) + ( paralaxOffset411 * ( _IrisParallaxPower * 4.0 ) ) );
				float mulTime765 = _TimeParameters.x * _IrisRotationAnim;
				float cos764 = cos( mulTime765 );
				float sin764 = sin( mulTime765 );
				float2 rotator764 = mul( texCoord190 - float2( 0.5,0.5 ) , float2x2( cos764 , -sin764 , sin764 , cos764 )) + float2( 0.5,0.5 );
				...
				float2 texCoord944 = IN.ase_texcoord5.xy * temp_cast_23 + temp_cast_24;
				float cos373 = cos( ( ( SafeNormalize(_MainLightPosition.xyz).x - _CausticRotationAdjust ) + ( 1.0 - tan( SafeNormalize(_MainLightPosition.xyz).y ) ) ) );
				float sin373 = sin( ( ( SafeNormalize(_MainLightPosition.xyz).x - _CausticRotationAdjust ) + ( 1.0 - tan( SafeNormalize(_MainLightPosition.xyz).y ) ) ) );
				float2 rotator373 = mul( texCoord944 - float2( 0.5,0.5 ) , float2x2( cos373 , -sin373 , sin373 , cos373 )) + float2( 0.5,0.5 );
				float4 tex2DNode370 = tex2D( _CausticMask, rotator373 );
				float temp_output_866_0 = ( 1.0 - _CausticTweak );
				float3 objectSpaceLightDir = IN.ase_texcoord10.xyz;
				float4 transform1155 = mul(GetWorldToObjectMatrix(),float4( ase_worldNormal , 0.0 ));
				float fresnelNdotV1143 = dot( normalize( transform1155.xyz ), objectSpaceLightDir );
				float fresnelNode1143 = ( _BSP_IrisDirectLit.x + _BSP_IrisDirectLit.y * pow( max( 1.0 - fresnelNdotV1143 , 0.0001 ), _BSP_IrisDirectLit.z ) );
				float Gummyness1146 = saturate( fresnelNode1143 );
				float4 lerpResult761 = lerp( ( _MinimumGlow_Instance * ( BaseIrisColors809 + ( BaseIrisColors809 * tex2DNode370 * ( _CausticPower * ( ( FresnelLight732 + temp_output_866_0 ) * temp_output_866_0 ) ) ) ) ) , ( BaseIrisColors809 + ( BaseIrisColors809 * tex2DNode370 * _CausticPower ) ) , ( ( 1.0 - clampResult894 ) * ( _CausticFX_inDarkness * 1111.0 ) * ( 1.0 - saturate( LightComponent779 ) ) * ( 1.0 + ( Gummyness1146 * _IrisDirectHitPower ) ) ));
				...
				float lerpResult1036 = lerp( FresnelLight732 , temp_output_861_0 , SSS_Spread954);
				float lerpResult1040 = lerp( ( lerpResult1036 + lerpResult1036 + lerpResult1036 + lerpResult1036 ) , clampResult994 , 0.5);
				float4 temp_cast_27 = (( lerpResult1040 * _MainLightColor.a )).xxxx;
				float4 lerpResult1039 = lerp( temp_cast_27 , temp_output_1045_0 , SSS_Spread954);
				float4 lerpResult1032 = lerp( SSS_forAlbedo1030 , lerpResult1039 , _FinalSSS_Mixer);
				float3 desaturateInitialColor1089 = lerpResult1032.rgb;
				float desaturateDot1089 = dot( desaturateInitialColor1089, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar1089 = lerp( desaturateInitialColor1089, desaturateDot1089.xxx, _FinalSSS_Desaturate );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord3_g145 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float simplePerlin3D4_g145 = snoise( float3( texCoord3_g145 ,  0.0 ) );
				float2 appendResult6_g145 = (float2(simplePerlin3D4_g145 , simplePerlin3D4_g145));
				float4 appendResult572 = (float4(appendResult6_g145 , 1.0 , 0.0));
				float2 temp_cast_3 = (_EyeSize).xx;
				float2 temp_cast_4 = (( ( 1.0 - _EyeSize ) / 2.0 )).xx;
				float2 texCoord264 = IN.ase_texcoord4.xy * temp_cast_3 + temp_cast_4;
				float2 eyeSizeUVs604 = texCoord264;
				float4 tex2DNode166 = tex2D( _RGBMask, eyeSizeUVs604 );
				float lerpResult706 = lerp( tex2DNode166.b , ( tex2DNode166.b - tex2DNode166.r ) , _LimbalEdge_Adjustment);
				float clampResult721 = clamp( lerpResult706 , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.CommentaryNode;219;-1716.819,1929.655;Inherit;False;2546.831;732.6423;IrisConeCaustics;28;373;50;334;370;737;745;750;757;759;760;761;762;782;779;763;811;864;866;863;902;903;906;905;824;948;904;1136;1137;Caustics;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;475;-1700.735,2697.333;Inherit;False;1855.592;580.5686;Eye Shading - Created local shadows around the eye (fake AO);14;672;461;466;462;459;484;465;483;464;457;463;458;1102;949;Eye Shading;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;693;-6649.773,-1945.334;Inherit;False;889.9717;218.2189;Comment;3;685;692;1164;GetLightColorIntensity;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1023;3223.931,-663.2455;Inherit;False;3022.493;1815.53;SSS Cluster;63;1037;912;1036;998;913;993;1000;995;914;861;859;858;1028;973;955;1005;994;1004;790;783;780;990;802;1033;1032;1030;960;803;959;908;787;981;797;909;788;907;893;954;953;1026;1001;987;986;1027;794;795;1025;789;785;793;1039;1040;1041;1043;1044;1045;1046;1047;1048;1090;1089;1091;1165;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1145;1656.606,-716.4761;Inherit;False;636.8799;413.0728;GUMMY;4;1143;1139;1138;1155;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;731;3123.164,2083.213;Inherit;False;875.4398;233.5352;Improved Light Falloff with inverse Fresnel and Light Dir;4;732;730;727;728;Light falloff simple;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldToObjectTransfNode;1155;1858.284,-778.4338;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TanOpNode;1136;-1677.585,2349.429;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1033;5077.377,955.4669;Inherit;False;Property;_FinalSSS_Mixer;FinalSSS_Mixer;47;0;Create;True;0;0;0;False;0;False;0;0.596;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;776;217.8759,859.0576;Float;False;Property;_LimbalRingGloss;LimbalRingGloss;11;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-276.5095,369.9954;Float;False;Property;_LensPush;LensPush;19;0;Create;True;0;0;0;False;0;False;0.64;0.678;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ObjSpaceLightDirHlpNode;1139;1670.683,-537.9219;Inherit;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;650;2730.831,1896.1;Inherit;False;625;PupilMaskArea;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1025;5764.178,-401.6704;Inherit;False;SS_FromDirLight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1026;4352.829,-3.204147;Inherit;False;1025;SS_FromDirLight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;953;5391.315,-584.2901;Inherit;False;Property;_SSS_Spread;SSS_Spread;44;0;Create;True;0;0;0;False;0;False;0;0.375;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;961;5292.346,1447.277;Inherit;False;960;Final_illumination;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;847;4779.776,1688.752;Inherit;False;833;PupilGlow;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;959;5203.981,-494.5918;Inherit;False;Property;_Final_illumination;Final_illumination;49;0;Create;True;0;0;0;False;0;False;0.25;0.79;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;647;2736.821,1422.523;Float;False;Property;_PupilColorEmissivenessA;PupilColor-Emissiveness(A);30;0;Create;True;0;0;0;False;2;Header(Pupil Control);Space(6);False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;333;586.7011,158.6582;Float;False;Property;_ScleraBumpScale;ScleraBumpScale;13;0;Create;True;0;0;0;False;0;False;0;2.45;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;949;-210.4006,2729.982;Inherit;False;779;LightComponent;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1090;5386.262,960.1217;Inherit;False;Property;_FinalSSS_Desaturate;FinalSSS_Desaturate;48;0;Create;True;0;0;0;False;0;False;0;0.447;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1166;1588.02,1678.303;Inherit;False;LocalShadowing;-1;;142;cbbcb7bdaf1755b499ae374337e1f753;0;1;17;FLOAT;0;False;2;FLOAT;16;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;1137;-1544.983,2359.83;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;750;-490.9594,2525.562;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;27;0;Create;True;0;0;0;False;0;False;17;0.048;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;1165;4344.739,752.0076;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;722;-2105.917,-106.2091;Float;False;Property;_EyeBallMetalness;EyeBallMetalness;22;0;Create;True;0;0;0;False;0;False;0;0.239;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;723;-2128.732,-215.2754;Float;False;Property;_LimbalRingMetalness;LimbalRingMetalness;20;0;Create;True;0;0;0;False;2;Header(Metalness);Space(5);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;893;4412.054,-186.104;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;459;-1644.911,2747.333;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.BreakToComponentsNode;1164;-6462.18,-1862.307;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.PowerNode;466;-721.2878,2888.32;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT3;1,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1146;2474.682,-609.9188;Inherit;False;Gummyness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;759;-579.4992,2367.532;Inherit;False;ConstantBiasScale;-1;;144;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;669;66.0421,-499.0768;Inherit;False;MicroScatterScale_vec2;51;;145;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
Node;AmplifyShaderEditor.SaturateNode;1149;2298.875,-599.5511;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1043;3974.764,899.3177;Inherit;False;Property;_SSSColour_DesatA;SSSColour_Desat(A);43;0;Create;True;0;0;0;False;2;Header(Sub Surface control);Space (6);False;1,1,1,0;1,1,1,0.5529412;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1152;219.4188,3180.173;Inherit;False;Property;_IrisDirectHitPower;IrisDirectHitPower;29;0;Create;True;0;0;0;False;0;False;0;0;0;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-973.7299,2246.284;Float;False;Property;_CausticPower;CausticPower;25;0;Create;True;0;0;0;False;0;False;17;5.7;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1148;1775.563,-263.2417;Inherit;False;Property;_BSP_IrisDirectLit;BSP_IrisDirectLit;54;0;Create;True;0;0;0;False;2;Header(Finetuners);Space(5);False;0.23,-2.9,4;0.23,-2.9,4;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;1147;209.2179,3013.052;Inherit;False;1146;Gummyness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;902;-1557.006,2121.197;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;180;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1018;-2680.4,-284.6308;Inherit;True;ConstantBiasScale;-1;;146;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1142;1616.885,-400.5609;Inherit;False;Property;_Float2;Float 2;53;0;Create;True;0;0;0;False;0;False;0;6.163949;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;724;-2111.768,155.1683;Float;False;Property;_IrisPupilMetalness;IrisPupilMetalness;21;0;Create;True;0;0;0;False;0;False;0;0.103;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;370;-674.2144,2060.136;Inherit;True;Property;_CausticMask;CausticMask;23;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(Caustic FX);Space(5);False;-1;None;d9e87f40b033e4245bb68d58ff0930bc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;941;-1789.513,1613.438;Float;False;Property;_CausticSize;CausticSize;26;0;Create;True;0;0;0;False;0;False;1;0.46;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;864;-1111.685,2454.233;Inherit;False;Property;_CausticTweak;CausticTweak;24;0;Create;True;0;0;0;False;0;False;2.2;1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1050;4475.712,2244.388;Inherit;False;Property;_LimbalRingEmissivePower;LimbalRingEmissivePower;12;0;Create;True;0;0;0;False;0;False;0;0.37;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;844;4082.725,1877.263;Inherit;False;625;PupilMaskArea;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;881;-422.3004,1754.308;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldNormalVector;1138;1688.976,-687.4761;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-5598.821,-1329.853;Half;False;Property;_PupilSize;PupilSize;31;0;Create;True;0;0;0;False;0;False;70;50.9;0.001;99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1021;-3120.068,322.5037;Float;False;Property;_LimbalEdge_Finesse;LimbalEdge_Finesse;9;0;Create;True;0;0;0;False;0;False;0;0.37;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1008;-5491.217,-510.6634;Float;False;Property;_ParallaxMaskInverter;ParallaxMaskInverter;37;0;Create;True;0;0;0;False;0;False;1;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;185;-1903.107,1108.585;Inherit;True;Property;_IrisExtraDetail;IrisExtraDetail;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;7b7c97e104d9817418725e17f5ca2659;e988a3899ec59bd4c807ce4976eca317;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;789;5263.152,-405.3394;Float;False;Property;_SSS_Light_Contact;SSS_Light_Contact;45;0;Create;True;0;0;0;False;0;False;1;-0.01;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;880;-226.5528,1691.123;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;170;-1908.036,772.9764;Float;False;Property;_EyeVeinColorAmountA;EyeVeinColor-Amount(A);7;0;Create;True;0;0;0;False;0;False;0.375,0,0,0;0.6792453,0.3329778,0.247775,0.9686275;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3461.919,-655.2391;Float;False;Property;_EyeSize;EyeSize;14;0;Create;True;0;0;0;False;2;Header(Sizing and Tweaks);Space(5);False;1;0.7;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;416;-5794.375,-837.6871;Inherit;True;Property;_ParallaxMask;ParallaxMask;36;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(Parallax Control);Space(5);False;-1;None;451268057d3fa344e8695ec36ec39129;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;707;-3124.148,221.993;Float;False;Property;_LimbalEdge_Adjustment;LimbalEdge_Adjustment;10;0;Create;True;0;0;0;False;0;False;0;0.778;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1154;5767.196,1240.809;Inherit;False;1146;Gummyness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;779;-1209.015,2335.379;Float;False;LightComponent;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;257;-5668.911,-1030.676;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;39;0;Create;True;0;0;0;False;0;False;2.5;2.82;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;328;-4265.182,-1308.615;Float;False;Property;_IrisPupilBond;Iris-Pupil-Bond;16;0;Create;True;0;0;0;False;0;False;0.017;0.0277;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;-3471.69,-774.9874;Float;False;Property;_IrisSize;IrisSize;15;0;Create;True;0;0;0;False;0;False;1;1.38;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;419;-5188.922,-654.3204;Float;False;Property;_PushParallaxMask;PushParallaxMask;38;0;Create;True;0;0;0;False;0;False;1;0.5;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-4898.95,-1068.525;Float;False;Property;_PupilHeightWidthRatio;Pupil HeightWidthRatio;32;0;Create;True;0;0;0;False;0;False;1;6.49;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;543;-5604.761,-1418.477;Float;False;Property;_PupilAutoDilateFactor;PupilAutoDilateFactor;34;0;Create;True;0;0;0;False;0;False;0;17.2;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;535;-5604.813,-1241.473;Float;False;Property;_PupilAffectedByLight_Amount;PupilAffectedByLight_Amount;35;0;Create;True;0;0;0;False;0;False;0;0.154;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;692;-6292.385,-1858.472;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-3061.348,-1158.257;Float;False;Property;_PupilSharpness;PupilSharpness;33;0;Create;True;0;0;0;False;0;False;5;3.19;0.1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;879;-455.406,1618.435;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);6;0;Create;True;0;0;0;False;0;False;0.08088237,0.07573904,0.04698314,0.591;0.3495283,0.3679245,0,0.997;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1027;4103.54,-177.0645;Inherit;False;1025;SS_FromDirLight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;499;335.7147,-226.6894;Float;False;Property;_Eyeball_microScatter;Eyeball_microScatter;50;0;Create;True;0;0;0;False;2;Header(Micro Scatter);Space(5);False;0;1.27;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-753.7518,947.6635;Float;False;Property;_LensGloss;LensGloss;18;0;Create;True;0;0;0;False;0;False;0.98;0.875;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;489;-228.8091,1838.745;Float;False;InstancedProperty;_MinimumGlow;MinimumGlow;42;0;Create;True;0;0;0;False;0;False;0.2;0.068;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;767;-2727.793,1104.862;Float;False;Property;_IrisRotationAnim;IrisRotationAnim;17;0;Create;True;0;0;0;False;0;False;0;0;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;939;-2951.167,1639.931;Inherit;False;Property;_IrisParallaxPower;IrisParallaxPower;40;0;Create;True;0;0;0;False;0;False;0.4;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;903;-1914.422,2095.335;Inherit;False;Property;_CausticRotationAdjust;CausticRotationAdjust;28;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;993;3994.602,475.5406;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1167;-5715.541,-1608.325;Inherit;False;PupilAffectedByLight_float;-1;;147;676c5e5a2752c454fab10b64fa534af1;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;483;-439.5578,2937.341;Inherit;False;Lerp White To;-1;;148;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;1158;3155.873,2351.469;Inherit;False;Property;_FresLightEyeBall;FresLightEyeBall;55;0;Create;True;0;0;0;False;0;False;0.7,-0.3,-0.15;0.7,-0.3,-0.15;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;126;-724.2595,1519.134;Float;False;Property;_IrisBaseColor;IrisBaseColor;5;0;Create;True;0;0;0;False;0;False;0.4999702,0.5441177,0.4641004,1;0.03925872,0.04716976,0.005636639,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;133;-3418.101,640.369;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);4;0;Create;True;0;0;0;False;2;Header(Color Customization);Space(6);False;1,1,1,0.853;0.8773585,0.8745995,0.8745995,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LightColorNode;802;4126.752,736.8925;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;636;365.6531,1714.436;Inherit;False;LightDirectionZone_float;-1;;149;ce816473eb2cf6d4e96d84f2ab098aa5;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1122;-1422.01,3275.883;Float;False;Property;_EyeShadingPower;EyeShadingPower;41;0;Create;True;0;0;0;False;2;Header(Eye Shading);Space(5);False;1;0.01;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;376;-1973.334,2243.088;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;914;3264.751,488.7921;Inherit;False;Property;_SSS_Adjuster;SSS_Adjuster;46;0;Create;True;0;0;0;False;0;False;0.5;0.482;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;256;-4611.694,-510.8292;Float;False;Tangent;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.LightColorNode;685;-6629.239,-1905.82;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;182;-3417.43,830.8748;Float;False;Property;_RingColorAmount;RingColor-Amount;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1168;-1423.985,3172.485;Inherit;False;LocalShadowing;-1;;150;cbbcb7bdaf1755b499ae374337e1f753;0;1;17;FLOAT;0;False;2;FLOAT;16;FLOAT3;0
...
Node;AmplifyShaderEditor.FresnelNode;1143;1969.819,-598.3915;Inherit;True;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;3;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;851;5977.844,1606.051;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;850;5977.844,1606.051;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1160;6100.47,1592.757;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;853;5977.844,1606.051;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;854;5977.844,1606.051;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;852;5977.844,1606.051;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1159;6100.47,1592.757;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;849;6100.47,1532.757;Float;False;True;-1;2;;0;12;RRF_HumanShaders/EyeShaders/EyeShader_Model4URP;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;0;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1169;6100.47,1612.757;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1170;6100.47,1612.757;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
WireConnection;928;0;411;0
WireConnection;928;1;927;0
WireConnection;153;0;151;0
WireConnection;153;1;156;0
WireConnection;1155;0;1138;0
...
WireConnection;1102;0;1168;16
WireConnection;1102;1;1168;0
...
WireConnection;1107;0;1166;16
WireConnection;1107;1;1166;0
...
ASEEND*/
//CHKSM=B455F9C54110A21CAC07DB1008E48302C2EF1A39