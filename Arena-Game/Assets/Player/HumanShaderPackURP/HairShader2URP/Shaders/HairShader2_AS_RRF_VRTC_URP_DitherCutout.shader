	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_VRTC = IN.ase_texcoord8.xy * _VRTC_ST.xy + _VRTC_ST.zw;
				...
				float2 texCoord316 = IN.ase_texcoord8.xy * appendResult365 + float2( 0,0 );
				...
				float saferPower106 = abs( sinTH97 );
				...
				float saferPower258 = abs( sinTHL2256 );
				...
				float3 objToWorldDir343 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 0 ) ).xyz;
				...
				float2 texCoord376 = IN.ase_texcoord8.xy * appendResult390 + float2( 0,0 );
				float saferPower391 = abs( ( texCoord376.y * _Stretch ) );
				...
				float3 BaseColor = OUTPUT_Albedo407.rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord421 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_420_0 = ( _PushHairs * pow( ( 1.0 - texCoord421.y ) , _PushHairs_Bias ) * v.ase_normal );
				float3 OUTPUT_VertexMotion423 = temp_output_420_0;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_VRTC = IN.ase_texcoord4.xy * _VRTC_ST.xy + _VRTC_ST.zw;
				float4 tex2DNode335 = tex2D( _VRTC, uv_VRTC );
				#ifdef _USEVRTC_BIASANDSCALE_ON
				float4 staticSwitch373 = ( ( tex2DNode335 + _VRTC_Bias ) * _VRTC_Scale );
				#else
				...
				float originalAlphaCutout403 = tex2DNode335.a;
				float2 appendResult365 = (float2(_NoisePower , 0.1));
				float2 texCoord316 = IN.ase_texcoord4.xy * appendResult365 + float2( 0,0 );
				float simplePerlin2D315 = snoise( texCoord316 );
				float NoiseFX312 = ( ( tex2DNode7.g + _Spread ) * ( originalAlphaCutout403 * simplePerlin2D315 ) * _Spread );
				float4 appendResult305 = (float4(SafeNormalize(_MainLightPosition.xyz).x , ( ( _MainHighlightPosition + NoiseFX312 ) + SafeNormalize(_MainLightPosition.xyz).y ) , SafeNormalize(_MainLightPosition.xyz).z , 0.0));
				...
				float Original_HairAlpha392 = ( originalAlphaCutout403 * _Alpha_Level );
				float2 appendResult390 = (float2(_XTiling , 1.0));
				float2 texCoord376 = IN.ase_texcoord4.xy * appendResult390 + float2( 0,0 );
				float saferPower391 = abs( ( texCoord376.y * _Stretch ) );
				float2 appendResult381 = (float2(texCoord376.x , pow( saferPower391 , 0.5 )));
				float OUTPUT_HairOpacity388 = ( Original_HairAlpha392 * tex2D( _ExtraCuttingR, appendResult381 ).r );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_VRTC = IN.ase_texcoord.xy * _VRTC_ST.xy + _VRTC_ST.zw;
				float4 tex2DNode335 = tex2D( _VRTC, uv_VRTC );
				float originalAlphaCutout403 = tex2DNode335.a;
				float Original_HairAlpha392 = ( originalAlphaCutout403 * _Alpha_Level );
				float2 appendResult390 = (float2(_XTiling , 1.0));
				float2 texCoord376 = IN.ase_texcoord.xy * appendResult390 + float2( 0,0 );
				float saferPower391 = abs( ( texCoord376.y * _Stretch ) );
				float2 appendResult381 = (float2(texCoord376.x , pow( saferPower391 , 0.5 )));
				float OUTPUT_HairOpacity388 = ( Original_HairAlpha392 * tex2D( _ExtraCuttingR, appendResult381 ).r );
				...
				surfaceDescription.Alpha = lerpResult457;
...
Node;AmplifyShaderEditor.RangedFloatNode;364;-582.5151,885.101;Float;False;Property;_NoisePower;NoisePower;26;0;Create;True;0;0;0;False;0;False;0;138;0;2000;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;335;-2762.142,-606.1206;Inherit;True;Property;_VRTC;VRTC;7;0;Create;True;0;0;0;False;0;False;-1;None;782ef3ffdf428ce48934f5774562ea50;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-512.2765,424.4365;Float;False;Property;_BumpPower;BumpPower;15;0;Create;True;0;0;0;False;0;False;0.5;2.08;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-73.77025,365.0654;Inherit;True;Property;_NormalMap;NormalMap;5;0;Create;True;0;0;0;False;0;False;-1;cf24829a9bef4734582a302bd6f6d130;19591b8e62d2fbc46bcc771f083d5bcc;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;303;-4666.173,-818.6374;Float;False;Property;_MainHighlightPosition;Main Highlight Position;18;0;Create;True;0;0;0;False;0;False;0;-0.16;-1;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;244;-3992.72,-1179.694;Float;False;Property;_SecondaryHighlightPosition;Secondary Highlight Position;22;0;Create;True;0;0;0;False;0;False;0;0.6;-1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;384;715.2823,694.3094;Float;False;Property;_XTiling;XTiling;29;0;Create;True;0;0;0;False;0;False;0;5.42;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;1454.486,768.4529;Float;False;Property;_Stretch;Stretch;28;0;Create;True;0;0;0;False;0;False;0.4961396;0.692;0.01;1.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;-2729.725,-381.3201;Float;False;Property;_VRTC_Bias;VRTC_Bias;9;0;Create;True;0;0;0;False;0;False;0;0.165;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;371;-2728.873,-294.687;Float;False;Property;_VRTC_Scale;VRTC_Scale;10;0;Create;True;0;0;0;False;0;False;1;0.86;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;396;-2091.989,-289.3039;Float;False;Property;_Alpha_Level;Alpha_Level;6;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;373;-1935.277,-600.7404;Float;False;Property;_UseVRTC_BiasAndScale;UseVRTC_BiasAndScale?;8;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;329;-2045.256,-1287.893;Float;False;Property;_RootColorPowerA;RootColor-Power(A);13;0;Create;True;0;0;0;False;0;False;0.1102941,0.1005623,0.1005623,0.453;0.03373702,0.0474048,0.05882347,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;262;-2662.638,673.6901;Float;False;Property;_SecondaryHighlightExponent;Secondary Highlight Exponent;24;0;Create;True;0;0;0;False;0;False;0.2;78;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;327;-2427.24,-787.0815;Float;False;Property;_Variant_Color2_GlossA;Variant_Color2_Gloss(A);12;0;Create;True;0;0;0;False;0;False;0,0.1356491,0.7867647,0.516;0.02870891,0.4338235,0.2661898,0.272;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;107;-2597.844,129.8814;Float;False;Property;_MainHighlightExponent;Main Highlight Exponent;20;0;Create;True;0;0;0;False;0;False;0.2;97;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;326;-2428.317,-963.6812;Float;False;Property;_VariantColor1_GlossA;VariantColor1_Gloss(A);11;0;Create;True;0;0;0;False;0;False;0.8897059,0.1308391,0.1308391,0.516;0,0.5034479,1,0.466;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2592.595,210.4834;Float;False;Property;_MainHighlightStrength;Main Highlight Strength;19;0;Create;True;0;0;0;False;0;False;0.25;1.21;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;259;-2644.141,764.4827;Float;False;Property;_SecondaryHighlightStrength;Secondary Highlight Strength;23;0;Create;True;0;0;0;False;0;False;0.25;0.76;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;258;-2280.745,641.481;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;292;-1071.695,-941.9322;Float;False;Property;_TipColorPowerA;TipColor-Power(A);14;0;Create;True;0;0;0;False;0;False;0.9448277,1,0,0.484;0.6470588,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;264;-2017.542,831.6193;Float;False;Property;_SecondaryHighlightColor;Secondary Highlight Color;21;0;Create;True;0;0;0;False;0;False;0.8862069,0.8862069,0.8862069,0;0.168685,0.3947619,0.7647059,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;267;-2323.583,-261.4672;Float;False;Property;_MainHighlight_Color;MainHighlight_Color;17;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.05882347,0.6105477,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DitheringNode;454;2986.915,-1456.021;Inherit;False;0;True;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;456;2943.401,-1352.605;Inherit;False;Property;_DitheringAmount;Dithering Amount;33;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;357;929.132,1229.432;Float;False;Property;_SSS;SSS;4;0;Create;True;0;0;0;False;0;False;0;0.229;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;343;-225.4491,1401.88;Inherit;False;Object;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;29;2552.708,-1653.873;Float;False;Property;_Metallic;Metallic;16;0;Create;True;0;0;0;False;0;False;0;0.29;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;340;924.7745,1137.039;Float;False;Property;_BaseIllumination;BaseIllumination;3;0;Create;True;0;0;0;False;0;False;0.15;0.277;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;347;-247.6851,1548.879;Float;False;Property;_Light_Bias;Light_Bias;0;0;Create;True;0;0;0;False;0;False;0;0.0259;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;453;2912.446,-1624.141;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;32;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;351;118.6937,1671.82;Float;False;Property;_LightScatter;LightScatter;2;0;Create;True;0;0;0;False;0;False;0;0.184;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;455;3296.537,-1725.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;450;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;449;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;452;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;451;2942.537,-1783.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;448;3391.537,-1712.504;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;RRF_HumanShaders/HairShader2/HairShader2_AS_RRF_VRTC_URP;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;458;3391.537,-1652.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;459;3391.537,-1652.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;460;3391.537,-1652.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;461;3391.537,-1652.504;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.GetLocalVarNode;313;-4583.326,-1266.629;Inherit;True;312;NoiseFX;1;0;OBJECT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=A3AC92C6E42D520C7E95C01B4146A2C8408A0836
