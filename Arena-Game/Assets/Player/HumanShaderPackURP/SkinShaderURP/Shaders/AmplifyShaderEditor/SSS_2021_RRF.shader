...
Shader "RRF_HumanShaders/Skin/SSS_2021_RRF"
{
	Properties
	{
		...
		_SSS_SidePower("SSS_SidePower", Range( 0 , 1)) = 0.5
		...
		_FakeSSS_Add("FakeSSS_Add", Range( 0 , 1)) = 0
		_FinalToEmissive("FinalToEmissive", Range( 0 , 5)) = 0.5
		_UseEpidermalColour("UseEpidermalColour", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _SSS_OldMax;
			float _UseEpidermalColour;
			float _SSS_SidePower;
			float _SSSFinal;
			float _FakeSSS_Add;
			float _FinalToEmissive;
						 ...
						 ) : SV_Target
			{
				...
				float dotResult630 = dot( _MainLightPosition.xyz , ( WorldNormal + ( FinalNormal405 * 0.1 ) ) );
				...
				float4 temp_output_43_0_g73 = temp_cast_5;
				float3 normalizeResult4_g74 = normalize( ( WorldViewDirection + _MainLightPosition.xyz ) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal12_g73 = FinalNormal405;
				float3 worldNormal12_g73 = float3(dot(tanToWorld0,tanNormal12_g73), dot(tanToWorld1,tanNormal12_g73), dot(tanToWorld2,tanNormal12_g73));
				float3 normalizeResult64_g73 = normalize( worldNormal12_g73 );
				float dotResult19_g73 = dot( normalizeResult4_g74 , normalizeResult64_g73 );
				float ase_lightAtten = 0;
				Light ase_lightAtten_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_lightAtten_mainLight.distanceAttenuation * ase_lightAtten_mainLight.shadowAttenuation;
				float4 temp_output_40_0_g73 = ( _MainLightColor * ase_lightAtten );
				float dotResult14_g73 = dot( normalizeResult64_g73 , _MainLightPosition.xyz );
				float3 bakedGI34_g73 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, normalizeResult64_g73);
				float4 temp_output_42_0_g73 = _MainColor;
				float3 desaturateInitialColor832 = saturate( ( ( ( LightDotNormal707 * ( ( float4( (temp_output_43_0_g73).rgb , 0.0 ) * (temp_output_43_0_g73).a * pow( max( dotResult19_g73 , 0.0 ) , ( _Shininess * 128.0 ) ) * temp_output_40_0_g73 ) + ( ( ( temp_output_40_0_g73 * max( dotResult14_g73 , 0.0 ) ) + float4( bakedGI34_g73 , 0.0 ) ) * float4( (temp_output_42_0_g73).rgb , 0.0 ) ) ) * ase_lightAtten * _MainLightColor * float4( BaseColour399 , 0.0 ) ) + _DualSpecBias ) * _DualSpecScale ) ).rgb;
				...
				float temp_output_2_0_g77 = _SSS_UseAlphaWeight;
				float temp_output_3_0_g77 = ( 1.0 - temp_output_2_0_g77 );
				float3 appendResult7_g77 = (float3(temp_output_3_0_g77 , temp_output_3_0_g77 , temp_output_3_0_g77));
				float4 lerpResult493 = lerp( tex2DNode114 , float4( ( ( temp_cast_14 * temp_output_2_0_g77 ) + appendResult7_g77 ) , 0.0 ) , _SSS_ForceAlphaWeight);
				...
				float dotResult612 = dot( transform613 , float4( WorldNormal , 0.0 ) );
				...
				float saferPower768 = max( ( _LightAttn_Shift + ase_lightAtten ) , 0.0001 );
				float saferPower759 = max( ( 1.0 - ( _LightAttn_Shift + ase_lightAtten ) ) , 0.0001 );
				float temp_output_736_0 = ( pow( saferPower768 , _Refine_LightAttenSSS ) * pow( saferPower759 , _Refine_LightAttenSSS ) );
				...
				float temp_output_770_0 = ( ( lerpResult725 + _SubScatterShift ) * ase_lightAtten );
				Gradient gradient863 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.08148318 ), float4( 0, 0, 0, 0.4854505 ), float4( 1, 0.9969188, 0.9859152, 0.9918517 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 lerpResult865 = lerp( SampleGradient( gradient703, temp_output_770_0 ) , ( SampleGradient( gradient863, temp_output_770_0 ) * _EpidermalColor ) , _UseEpidermalColour);
				float4 blendOpSrc713 = float4( 0,0,0,0 );
				float4 blendOpDest713 = lerpResult865;
				float4 lerpBlendMode713 = lerp(blendOpDest713,(( blendOpDest713 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest713 ) * ( 1.0 - blendOpSrc713 ) ) : ( 2.0 * blendOpDest713 * blendOpSrc713 ) ),( 1.0 - _SSS_SidePower ));
				float4 clampResult646 = clamp( ( ( clampResult540 + ( temp_output_510_0 * BackScatter508 ) ) + float4( lerpResult433 , 0.0 ) + ( ( SSS_Band592 * ( temp_output_698_0 * temp_output_698_0 ) ) * temp_output_510_0 * LightDotView606 * ViewDotNormal621 * FresBackScatterMask797 ) + ( FineSSS_Band640 * temp_output_694_0 * float4( desaturateVar653 , 0.0 ) ) + ( ( saturate( lerpBlendMode713 )) * _SSSFinal ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 FinalEmission277 = clampResult646;
				Gradient gradient840 = NewGradient( 0, 4, 2, float4( 0, 0, 0, 0 ), float4( 0.1792453, 0.01634625, 0.01634625, 0.7075303 ), float4( 0.3921569, 0.1176471, 0.007843138, 0.8332036 ), float4( 0.8113208, 0.5371034, 0.410763, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float dotResult5_g72 = dot( WorldNormal , _MainLightPosition.xyz );
				float4 lerpResult842 = lerp( float4( 0,0,0,0 ) , SampleGradient( gradient840, (dotResult5_g72*0.5 + 0.5) ) , _FakeSSS_Add);
				float lerpResult850 = lerp( tex2DNode114.r , ( tex2DNode114.r * tex2DNode114.a ) , 0.8);
				float PseudoDemal851 = lerpResult850;
				...
				float temp_output_2_0_g71 = saturate( temp_output_692_0 );
				float temp_output_3_0_g71 = ( 1.0 - temp_output_2_0_g71 );
				float3 appendResult7_g71 = (float3(temp_output_3_0_g71 , temp_output_3_0_g71 , temp_output_3_0_g71));
				...
				float3 indirectSpecular803 = GlossyEnvironmentReflection( reflectVector803, 1.0 - FinalGloss237, ( ( temp_cast_25 * temp_output_2_0_g71 ) + appendResult7_g71 ).x );
				...
				float3 Emission = ( ( float4( desaturateVar832 , 0.0 ) + FinalEmission277 + lerpResult842 ) * _FinalToEmissive * PseudoDemal851 ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 normalizeResult188 = normalize( lerpResult187 );
				float3 FinalNormal405 = normalizeResult188;
				float dotResult630 = dot( _MainLightPosition.xyz , ( ase_worldNormal + ( FinalNormal405 * 0.1 ) ) );
				float LightDotNormal707 = dotResult630;
				...
				float3 normalizeResult4_g74 = normalize( ( ase_worldViewDir + _MainLightPosition.xyz ) );
				...
				float dotResult612 = dot( transform613 , float4( ase_worldNormal , 0.0 ) );
				float clampResult618 = clamp( ( 1.0 - ( ( dotResult612 + 0.25 ) * 0.85 ) ) , 0.0 , 1.0 );
				float ViewDotNormal621 = clampResult618;
				float clampResult645 = clamp( ( _SSS_ToEmissive * FresBackScatterMask797 * ViewDotNormal621 ) , 0.0 , 1.0 );
				float BackScatter508 = clampResult645;
				...
				float4 FinalEmission277 = clampResult646;
				Gradient gradient840 = NewGradient( 0, 4, 2, float4( 0, 0, 0, 0 ), float4( 0.1792453, 0.01634625, 0.01634625, 0.7075303 ), float4( 0.3921569, 0.1176471, 0.007843138, 0.8332036 ), float4( 0.8113208, 0.5371034, 0.410763, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float dotResult5_g72 = dot( ase_worldNormal , _MainLightPosition.xyz );
				float4 lerpResult842 = lerp( float4( 0,0,0,0 ) , SampleGradient( gradient840, (dotResult5_g72*0.5 + 0.5) ) , _FakeSSS_Add);
				float lerpResult850 = lerp( tex2DNode114.r , ( tex2DNode114.r * tex2DNode114.a ) , 0.8);
				float PseudoDemal851 = lerpResult850;
...
/*ASEBEGIN
Version=18912
-171.3333;550.6667;1908.667;776.3334;1036.483;872.8829;1.173615;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-1972.178,1070.482;Float;False;Property;_MicroDetail_Tiling;MicroDetail_Tiling;21;0;Create;True;0;0;0;False;0;False;10;10;1;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;-1958.245,1189.618;Float;False;Property;_MicroDetail_Offset;MicroDetail_Offset;22;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;-1968.873,1301.657;Float;False;Property;_MicroDetail_Power;MicroDetail_Power;23;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;810;-1606.042,901.5248;Inherit;True;Property;_Normal_Map;Normal_Map;19;0;Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;811;-1617.039,1243.532;Inherit;True;Property;_Micro_Detail_NormalMap;Micro_Detail_NormalMap;20;0;Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;689;-1960.338,968.8049;Inherit;False;Property;_SoftenMicroNormals;Soften Micro Normals;24;0;Create;True;0;0;0;False;0;False;0;0;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;137;-1265.938,1132.384;Inherit;True;Property;_MicroDetailNormalMap;MicroDetail(NormalMap);16;0;Create;True;0;0;0;False;0;False;-1;None;287acedd1e86ed140951c44576dc5b5c;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;111;-1260.253,917.9229;Inherit;True;Property;_NormalMap;NormalMap;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;185;-236.6692,1178.826;Float;False;Property;_FinalNormalMapPower;FinalNormalMapPower;26;0;Create;True;0;0;0;False;0;False;1;1;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;186;-290.3551,914.5228;Float;False;Constant;_Vector0;Vector 0;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.CommentaryNode;751;-2104.573,-977.6867;Inherit;False;3043.432;1789.451;Final SSS Mixing;62;113;571;645;627;650;446;699;653;694;398;697;434;594;539;548;435;656;593;575;433;599;698;648;641;597;646;277;713;574;738;741;704;703;718;540;735;734;732;702;730;736;726;712;725;719;570;399;626;508;760;762;761;763;767;759;768;769;771;770;836;863;866;;1,1,1,1;0;0
Node;AmplifyShaderEditor.NormalizeNode;188;69.86812,1104.626;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;639;-4964.384,603.2914;Inherit;False;1569.841;812.3967;FineBand;16;717;629;707;716;630;638;714;640;634;636;637;708;635;715;647;845;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;748;-4850.261,1969.334;Inherit;False;1419.37;517.7581;View Dot Normal;10;610;613;616;612;615;614;617;618;621;844;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;762;-1605.068,-784.4299;Inherit;False;Property;_LightAttn_Shift;LightAttn_Shift;41;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;716;-4844.407,1034.301;Inherit;False;Constant;_Float2;Float 2;38;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;730;-1551.488,-539.7961;Inherit;False;Property;_Refine_LightAttenSSS;Refine_LightAttenSSS;38;0;Create;True;0;0;0;False;0;False;1;-0.002;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;845;-4873.537,801.2502;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;844;-4616.424,2211.315;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;534;-3261.937,1343.927;Inherit;False;Property;_SSS_LighFresPower;SSS_LighFresPower;32;0;Create;True;0;0;0;False;0;False;0;0.097;-0.1;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;616;-4411.973,2371.093;Inherit;False;Constant;_Float1;Float 1;35;0;Create;True;0;0;0;False;0;False;0.85;0.85;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;768;-1068.068,-800.4299;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;533;-3277.937,1263.927;Inherit;False;Property;_SSS_LighFresScale;SSS_LighFresScale;31;0;Create;True;0;0;0;False;0;False;-0.1;0.039;-0.15;0.15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;532;-3277.937,1183.927;Inherit;False;Property;_SSS_LighFresBias;SSS_LighFresBias;30;0;Create;True;0;0;0;False;0;False;0;0.011;-0.15;0.15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;615;-4424.149,2262.859;Inherit;False;Constant;_Float0;Float 0;34;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;759;-1078.539,-609.2061;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;614;-4180.624,2070.745;Inherit;False;ConstantBiasScale;-1;;75;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-4909.667,1765.068;Inherit;False;Property;_SSS_NewMin;SSS_NewMin;35;0;Create;True;0;0;0;False;0;False;2.2;1.7;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;638;-4621.634,1137.16;Inherit;False;Property;_Epidermal_Exp;Epidermal_Exp;51;0;Create;True;0;0;0;False;0;False;0;2.53;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;587;-4954.667,1681.068;Inherit;False;Property;_SSS_OldMin;SSS_OldMin;33;0;Create;True;0;0;0;False;0;False;0.05;0.223;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;396;-3076.573,-74.89666;Inherit;False;Property;_ForwardLight_Scale;ForwardLight_Scale;17;0;Create;True;0;0;0;False;0;False;0;0.784;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;588;-4773.667,1725.068;Inherit;False;Property;_SSS_OldMax;SSS_OldMax;34;0;Create;True;0;0;0;False;0;False;-3;-0.07;-5;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;395;-3092.275,-240.7136;Inherit;False;Property;_ForwardLight_Bias;ForwardLight_Bias;16;0;Create;True;0;0;0;False;0;False;0;0.57;-1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;726;-907.564,-420.5797;Inherit;False;Property;_SubScatterMix;SubScatterMix;40;0;Create;True;0;0;0;False;0;False;0.25;0.368;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;586;-4731.667,1815.068;Inherit;False;Property;_SSS_NewMax;SSS_NewMax;36;0;Create;True;0;0;0;False;0;False;-7;-2.4;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;636;-4629.634,1250.16;Inherit;False;Property;_EpidermalTweak;EpidermalTweak;43;0;Create;True;0;0;0;False;0;False;0;-0.273;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;394;-2751.281,-307.5204;Inherit;False;ConstantBiasScale;-1;;76;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;51;-2518.228,-786.8037;Float;False;Property;_Albedo_Tint;Albedo_Tint;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6132076,0.6132076,0.6132076,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;719;-895.564,-319.5797;Inherit;False;Property;_SubScatterShift;SubScatterShift;39;0;Create;True;0;0;0;False;0;False;0;-0.04;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;112;-2554.377,-992.9136;Inherit;True;Property;_Albedo;Albedo;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;411;-3167.102,86.82392;Inherit;False;894.2906;626.259;SSS Maps;10;494;393;44;117;114;493;509;849;850;851;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;571;-2026.626,-797.9168;Inherit;False;Property;_AlbedoDesaturation;AlbedoDesaturation;7;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;118;1058.576,-770.7048;Inherit;True;Property;_MetalGloss;Metal-Gloss;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;243;-3079.875,-157.3074;Float;False;Property;_SSS_ToEmissive;SSS_ToEmissive;15;0;Create;True;0;0;0;False;0;False;0.1;2.74;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;59;1077.181,-561.9395;Float;False;Property;_SmoothnessDeviate;SmoothnessDeviate;10;0;Create;True;0;0;0;False;0;False;0;0.52;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;42;-2763.198,-474.6644;Float;False;Property;_MainLightTint;MainLightTint;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6415094,0.6415094,0.6415094,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;117;-3128.014,493.4392;Float;False;Property;_SSS_UseAlphaWeight;SSS_UseAlphaWeight;13;0;Create;True;0;0;0;False;0;False;0;0.18;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;863;-386.4007,-746.8557;Inherit;False;0;3;2;0,0,0,0.08148318;0,0,0,0.4854505;1,0.9969188,0.9859152,0.9918517;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.ColorNode;44;-3124.115,135.4704;Float;False;Property;_ScatterColor;ScatterColor;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6698113,0.6698113,0.6698113,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;494;-2976.798,629.8943;Float;False;Property;_SSS_ForceAlphaWeight;SSS_ForceAlphaWeight;14;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;656;-1757.856,474.5403;Float;False;Property;_EpidermalColor;EpidermalColor;42;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3237742,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GradientSampleNode;862;-173.1343,-733.1505;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;393;-2815.697,495.3599;Inherit;False;Lerp White To;-1;;77;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;800;1157.205,563.6138;Inherit;False;1489.817;877.7885;Comment;19;271;701;292;403;406;692;690;317;691;408;801;803;823;404;409;839;847;848;846;OUTPUTS;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;866;216.9371,-536.0556;Inherit;False;Property;_UseEpidermalColour;UseEpidermalColour;50;0;Create;True;0;0;0;False;0;False;0;0.99;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;864;183.1275,-749.1514;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;738;-190.7274,-295.5968;Inherit;False;Property;_SSS_SidePower;SSS_SidePower;37;0;Create;True;0;0;0;False;0;False;0.5;0.855;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;865;388.2849,-710.9241;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;818;1214.098,250.6888;Inherit;False;Property;_DualSpec;DualSpec;44;0;Create;True;0;0;0;False;0;False;0;5.04;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;741;106.6793,-402.8563;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;435;-1522.418,10.29995;Inherit;False;Property;_Base_Glow;Base_Glow;18;0;Create;True;0;0;0;False;0;False;0.05;0.008;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;836;-229.5774,-191.7488;Inherit;False;Property;_SSSFinal;SSSFinal;47;0;Create;True;0;0;0;False;0;False;0.25;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;713;435.2248,-464.2569;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;817;1590.638,200.4129;Inherit;False;Blinn-Phong Light;0;;73;cf814dba44d007a4e958d2ddd5813da6;0;3;42;COLOR;0,0,0,0;False;52;FLOAT3;0,0,0;False;43;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT;57
...
Node;AmplifyShaderEditor.RangedFloatNode;821;1942.411,25.92676;Inherit;False;Property;_DualSpecBias;DualSpecBias;46;0;Create;True;0;0;0;False;0;False;0;-1.15;-5;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;574;270.5504,-125.9752;Inherit;False;5;5;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;822;2031.711,224.3469;Inherit;False;Property;_DualSpecScale;DualSpecScale;45;0;Create;True;0;0;0;False;0;False;0;0.068;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;806;1458.629,1285.883;Inherit;False;Constant;_Float3;Float 3;43;0;Create;True;0;0;0;False;0;False;100;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;691;1277.531,1222.803;Inherit;False;Property;_FakeOcclusion;FakeOcclusion;52;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;291;1088.468,-339.1072;Inherit;True;Property;_OpacityTexture;OpacityTexture;27;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;315;1437.096,-740.3552;Float;False;Property;_MetalnessDeviate;MetalnessDeviate;9;0;Create;True;0;0;0;False;0;False;0;-0.32;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;840;2313.621,557.9568;Inherit;False;0;4;2;0,0,0,0;0.1792453,0.01634625,0.01634625,0.7075303;0.3921569,0.1176471,0.007843138,0.8332036;0.8113208,0.5371034,0.410763,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;820;2242.212,100.1468;Inherit;False;ConstantBiasScale;-1;;70;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;839;2293.548,640.8594;Inherit;False;Half Lambert Term;-1;;72;86299dc21373a954aa5772333626c9c1;0;1;3;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;849;-2840.136,363.5069;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;295;1297.749,-134.391;Inherit;False;Property;_DitherAmount;DitherAmount;29;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;850;-2696.534,290.4095;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.8;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;843;2664.675,765.289;Inherit;False;Property;_FakeSSS_Add;FakeSSS_Add;48;0;Create;True;0;0;0;False;0;False;0;0.608;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientSampleNode;841;2597.397,569.8912;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DitheringNode;293;1399.189,-259.643;Inherit;False;0;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;842;3011.151,607.1761;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;851;-2550.528,270.677;Inherit;False;PseudoDemal;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;701;1957.739,1345.495;Inherit;False;Lerp White To;-1;;71;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;848;1711.218,960.9736;Inherit;False;851;PseudoDemal;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;847;1672.631,826.043;Inherit;False;Property;_FinalToEmissive;FinalToEmissive;49;0;Create;True;0;0;0;False;0;False;0.5;0.95;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;823;1864.37,678.5366;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DitheringNode;760;-586.739,-609.3062;Inherit;False;1;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;846;2044.752,819.0569;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;292;1207.205,1077.718;Inherit;False;Property;_AlphaClip;AlphaClip;28;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;273;6024.633,-40.72271;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;274;6024.633,-40.72271;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;853;2335.022,846.5884;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;271;2335.022,786.5884;Float;False;True;-1;2;;0;2;RRF_HumanShaders/Skin/SSS_2021_RRF;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;272;6024.633,-40.72271;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;612;1;844;0
WireConnection;607;0;605;0
WireConnection;717;0;845;0
...
WireConnection;849;0;114;1
WireConnection;849;1;114;4
WireConnection;692;0;690;0
WireConnection;692;1;691;0
WireConnection;692;2;806;0
WireConnection;850;0;114;1
...
ASEEND*/
//CHKSM=CFFB92570D12AD4A8C96081C3D83569EF7E72FF3