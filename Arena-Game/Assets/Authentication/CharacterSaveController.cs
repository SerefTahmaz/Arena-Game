...
namespace  ArenaGame.Managers.SaveManager
{
    public class CharacterSaveController
    {
        ...
        private void LoadEquipmentList(Character character)
        {
            m_HelmArmor = ItemSaveHandler.GetArmorItem(character.HelmArmor);
            m_ChestArmor = ItemSaveHandler.GetArmorItem(character.ChestArmor);
            m_GauntletsArmor = ItemSaveHandler.GetArmorItem(character.GaunletsArmor);
            m_LeggingArmor = ItemSaveHandler.GetArmorItem(character.LeggingArmor);
        }
        
        private void LoadInventoryList(Character character)
        {
            var itemsGuid = character.InventoryList;
