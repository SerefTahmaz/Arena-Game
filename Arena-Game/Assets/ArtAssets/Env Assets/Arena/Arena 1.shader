...
Shader "Arena 1"
{
	Properties
	{
		...
		[ASEBegin]_ScanAlbedo("Scan Albedo", 2D) = "white" {}
		_BrickAlbedo("Brick Albedo", 2D) = "white" {}
		_BrickNormal("Brick Normal", 2D) = "bump" {}
		_Scale("Scale", Float) = 1
		_ScanAmount("ScanAmount", Range( 0 , 1)) = 1
		_Scan2Amount("Scan2Amount", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_ScanAlbedo = IN.ase_texcoord8.xy * _ScanAlbedo_ST.xy + _ScanAlbedo_ST.zw;
				float4 tex2DNode13 = tex2D( _ScanAlbedo, uv_ScanAlbedo );
				float2 temp_output_31_0 = ( IN.ase_texcoord8.zw * ( _Tile * _Scale ) );
				float4 blendOpSrc15 = tex2DNode13;
				float4 blendOpDest15 = tex2D( _BrickAlbedo, temp_output_31_0 );
				float4 lerpBlendMode15 = lerp(blendOpDest15,( blendOpSrc15 * blendOpDest15 ),_ScanAmount);
				float4 blendOpSrc33 = tex2DNode13;
				float4 blendOpDest33 = ( saturate( lerpBlendMode15 ));
				float4 lerpBlendMode33 = lerp(blendOpDest33,(( blendOpDest33 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest33 ) * ( 1.0 - blendOpSrc33 ) ) : ( 2.0 * blendOpDest33 * blendOpSrc33 ) ),_Scan2Amount);
				
				float3 Albedo = ( saturate( lerpBlendMode33 )).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _BrickNormal, temp_output_31_0 ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_ScanAlbedo = IN.ase_texcoord4.xy * _ScanAlbedo_ST.xy + _ScanAlbedo_ST.zw;
				float4 tex2DNode13 = tex2D( _ScanAlbedo, uv_ScanAlbedo );
				float2 temp_output_31_0 = ( IN.ase_texcoord4.zw * ( _Tile * _Scale ) );
				float4 blendOpSrc15 = tex2DNode13;
				float4 blendOpDest15 = tex2D( _BrickAlbedo, temp_output_31_0 );
				float4 lerpBlendMode15 = lerp(blendOpDest15,( blendOpSrc15 * blendOpDest15 ),_ScanAmount);
				float4 blendOpSrc33 = tex2DNode13;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_ScanAlbedo = IN.ase_texcoord2.xy * _ScanAlbedo_ST.xy + _ScanAlbedo_ST.zw;
				float4 tex2DNode13 = tex2D( _ScanAlbedo, uv_ScanAlbedo );
				float2 temp_output_31_0 = ( IN.ase_texcoord2.zw * ( _Tile * _Scale ) );
				float4 blendOpSrc15 = tex2DNode13;
				float4 blendOpDest15 = tex2D( _BrickAlbedo, temp_output_31_0 );
				float4 lerpBlendMode15 = lerp(blendOpDest15,( blendOpSrc15 * blendOpDest15 ),_ScanAmount);
				float4 blendOpSrc33 = tex2DNode13;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_output_31_0 = ( IN.ase_texcoord4.xy * ( _Tile * _Scale ) );
...
/*ASEBEGIN
Version=18935
0;73;1920;920;1479.723;483.3348;1;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;19;-2144.224,-32.32907;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;16;-980.8302,89.7068;Inherit;False;Property;_ScanAmount;ScanAmount;4;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;15;-623.9304,-53.19321;Inherit;False;Multiply;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;33;-180.2731,-233.7848;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-1655.856,199.1612;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;28;-1335.155,376.3663;Inherit;True;Property;_TextureSample1;Texture Sample 1;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;27;-1418.566,46.43223;Inherit;True;Property;_TextureSample0;Texture Sample 0;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;30;-2470.997,70.39836;Inherit;False;1;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;34;-637.1729,-178.8848;Inherit;False;Property;_Scan2Amount;Scan2Amount;5;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;21;-1925.515,353.6708;Inherit;True;Property;_BrickNormal;Brick Normal;2;0;Create;True;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;13;-1368.432,-280.1932;Inherit;True;Property;_ScanAlbedo;Scan Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;26;-2406.99,381.4337;Inherit;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;18;-1837.09,-61.85875;Inherit;True;Property;_BrickAlbedo;Brick Albedo;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;24;-2425.698,206.6082;Inherit;False;Property;_Tile;Tile;6;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;32;-238.7227,239.6652;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-2092.385,222.8333;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=2686634EF62C3F2ADE22FE0AC9C2E6004A48DF34