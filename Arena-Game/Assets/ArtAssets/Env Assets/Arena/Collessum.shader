...
Shader "Collessum"
{
	Properties
	{
		...
		_AO("AO", Range( 0 , 1)) = 1
		_Smoothneess("Smoothneess", Range( 0 , 1)) = 0
		_Vector0("Vector 0", Vector) = (20,1,0,0)
		_PlasterAlbedo("Plaster Albedo", 2D) = "white" {}
		_PlasterNormal("Plaster Normal", 2D) = "bump" {}
		[ASEEnd]_PlasterScale("PlasterScale", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_END
			sampler2D _Albedo;
			sampler2D _PlasterAlbedo;
			sampler2D _Normal;
			sampler2D _PlasterNormal;
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_29_0 = (float2( 1,1 )*_PlasterScale + 0.0);
				float4 triplanar25 = TriplanarSampling25( _PlasterAlbedo, WorldPosition, WorldNormal, 1.0, temp_output_29_0, 1.0, 0 );
				float simplePerlin3D7_g3 = snoise( ( WorldPosition * float3( 1,1,1 ) )*_Vector0.x );
				simplePerlin3D7_g3 = simplePerlin3D7_g3*0.5 + 0.5;
				float4 temp_cast_1 = (simplePerlin3D7_g3).xxxx;
				float4 myVarName5_g3 = saturate( ( CalculateContrast(_Vector0.y,temp_cast_1) + _Vector0.z ) );
				float4 temp_output_5_0_g2 = myVarName5_g3;
				float4 lerpResult3_g2 = lerp( tex2D( _Albedo, uv_Albedo ) , triplanar25 , temp_output_5_0_g2);
				float4 temp_output_20_0 = lerpResult3_g2;
				float4 lerpResult14 = lerp( temp_output_20_0 , _Color0 , IN.ase_color);
				float4 lerpResult16 = lerp( temp_output_20_0 , lerpResult14 , _AO);
				
				float2 uv_Normal = IN.ase_texcoord8.xy * _Normal_ST.xy + _Normal_ST.zw;
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar28 = TriplanarSampling28( _PlasterNormal, WorldPosition, WorldNormal, 1.0, temp_output_29_0, 1.0, 0 );
				float3 tanTriplanarNormal28 = mul( ase_worldToTangent, triplanar28 );
				float4 lerpResult6_g2 = lerp( float4( UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f ) , 0.0 ) , float4( tanTriplanarNormal28 , 0.0 ) , temp_output_5_0_g2);
				
				float3 Albedo = lerpResult16.rgb;
				float3 Normal = lerpResult6_g2.rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = _Smoothneess;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar25 = TriplanarSampling25( _PlasterAlbedo, WorldPosition, ase_worldNormal, 1.0, temp_output_29_0, 1.0, 0 );
				float simplePerlin3D7_g3 = snoise( ( WorldPosition * float3( 1,1,1 ) )*_Vector0.x );
				simplePerlin3D7_g3 = simplePerlin3D7_g3*0.5 + 0.5;
				float4 temp_cast_1 = (simplePerlin3D7_g3).xxxx;
				float4 myVarName5_g3 = saturate( ( CalculateContrast(_Vector0.y,temp_cast_1) + _Vector0.z ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float simplePerlin3D7_g3 = snoise( ( WorldPosition * float3( 1,1,1 ) )*_Vector0.x );
				simplePerlin3D7_g3 = simplePerlin3D7_g3*0.5 + 0.5;
				float4 temp_cast_2 = (simplePerlin3D7_g3).xxxx;
				float4 myVarName5_g3 = saturate( ( CalculateContrast(_Vector0.y,temp_cast_2) + _Vector0.z ) );
				float4 temp_output_5_0_g2 = myVarName5_g3;
				float4 lerpResult6_g2 = lerp( float4( UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f ) , 0.0 ) , float4( tanTriplanarNormal28 , 0.0 ) , temp_output_5_0_g2);
...
/*ASEBEGIN
Version=18935
0;73;1920;920;3537.548;-423.3495;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;17;-424.4242,97.76959;Inherit;False;Property;_AO;AO;5;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;29;-2270.049,1003.149;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;22;-2781.311,644.4111;Inherit;True;Property;_NormalPlaster;Normal Plaster;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;21;-2771.711,434.912;Inherit;True;Property;_AlbedoPlaster;Albedo Plaster;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;30;-2444.249,927.7497;Inherit;False;Constant;_Vector1;Vector 1;10;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;10;-2067.6,243.8001;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-2036.901,440.2993;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;24;-1837.378,23.14342;Inherit;False;PerlinNoiseCordinate;-1;;3;c75e63e53f6adeb4fa0c85c50727f4c3;0;4;16;FLOAT3;1,1,1;False;11;FLOAT;20;False;12;FLOAT;1;False;13;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;20;-1340.841,344.8047;Inherit;False;BlendPBR;-1;;2;99218621416599d4a97c1f8590d3f9e1;0;11;5;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;11;COLOR;0,0,0,0;False;16;COLOR;0,0,0,0;False;21;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;17;COLOR;0,0,0,0;False;20;COLOR;0,0,0,0;False;5;COLOR;0;COLOR;10;COLOR;14;COLOR;18;COLOR;22
Node;AmplifyShaderEditor.LerpOp;14;-386.4242,-182.2304;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-355.9238,526.8691;Inherit;False;Property;_Smoothneess;Smoothneess;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;27;-2666.781,1139.831;Inherit;True;Property;_PlasterNormal;Plaster Normal;9;0;Create;True;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;26;-2680.781,837.8311;Inherit;True;Property;_PlasterAlbedo;Plaster Albedo;8;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TriplanarNode;25;-1960.119,821.4937;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;23;-2300.104,28.6452;Inherit;False;Property;_Vector0;Vector 0;7;0;Create;True;0;0;0;False;0;False;20,1,0;20,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;31;-2510.548,1074.649;Inherit;False;Property;_PlasterScale;PlasterScale;10;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;16;-143.4242,-57.23041;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;15;-966.4242,-218.2304;Inherit;False;Property;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;28;-1970.781,1074.831;Inherit;True;Spherical;World;True;Top Texture 1;_TopTexture1;bump;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;13;-757.9095,-304.4467;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;24;11;23;1
WireConnection;24;12;23;2
WireConnection;24;13;23;3
WireConnection;20;5;24;0
WireConnection;20;2;10;0
WireConnection;20;7;11;0
WireConnection;20;4;25;0
WireConnection;20;8;28;0
...
WireConnection;1;1;20;10
WireConnection;1;4;18;0
ASEEND*/
//CHKSM=9AB83498A79FA175DBE56D21267561803FE39047