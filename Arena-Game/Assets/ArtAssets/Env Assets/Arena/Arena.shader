...
Shader "Arena"
{
	Properties
	{
		...
		[ASEEnd]_Saturation1("Saturation", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float3 TriplanarSampling20( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_25_0 = ( _Tile * _Scale );
				float4 triplanar17 = TriplanarSampling17( _BrickAlbedo, WorldPosition, WorldNormal, 1.0, temp_output_25_0, 1.0, 0 );
				float4 blendOpSrc15 = tex2DNode13;
				float4 blendOpDest15 = triplanar17;
				float4 lerpBlendMode15 = lerp(blendOpDest15,( blendOpSrc15 * blendOpDest15 ),_ScanAmount);
				float4 blendOpSrc29 = tex2DNode13;
				float4 blendOpDest29 = ( saturate( lerpBlendMode15 ));
				float4 lerpBlendMode29 = lerp(blendOpDest29,(( blendOpDest29 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest29 ) * ( 1.0 - blendOpSrc29 ) ) : ( 2.0 * blendOpDest29 * blendOpSrc29 ) ),_Scan2Amount);
				float3 hsvTorgb32 = RGBToHSV( ( saturate( lerpBlendMode29 )).xyz );
				float3 hsvTorgb42 = HSVToRGB( float3(hsvTorgb32.x,( hsvTorgb32.y + _Saturation ),( hsvTorgb32.z + _Saturation1 )) );
				
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar20 = TriplanarSampling20( _BrickNormal, WorldPosition, WorldNormal, 1.0, temp_output_25_0, 1.0, 0 );
				float3 tanTriplanarNormal20 = mul( ase_worldToTangent, triplanar20 );
				
				float3 Albedo = hsvTorgb42;
				float3 Normal = tanTriplanarNormal20;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar17 = TriplanarSampling17( _BrickAlbedo, WorldPosition, ase_worldNormal, 1.0, temp_output_25_0, 1.0, 0 );
				float4 blendOpSrc15 = tex2DNode13;
				float4 blendOpDest15 = triplanar17;
				float4 lerpBlendMode15 = lerp(blendOpDest15,( blendOpSrc15 * blendOpDest15 ),_ScanAmount);
				float4 blendOpSrc29 = tex2DNode13;
...
/*ASEBEGIN
Version=18935
0;73;1920;920;546.9425;557.4525;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;27;-342.4486,231.8654;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;345.0575,-199.4525;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-48.9425,-137.4525;Inherit;False;Property;_Saturation;Saturation;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;384.0575,-74.45251;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-9.942505,-12.45251;Inherit;False;Property;_Saturation1;Saturation;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.HSVToRGBNode;42;526.0575,-230.4525;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TriplanarNode;17;-1406.925,38.6724;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RGBToHSVNode;32;51.69946,-309.4479;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.BlendOpsNode;29;-299.449,-239.1346;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-738.449,-145.1346;Inherit;False;Property;_Scan2Amount;Scan2Amount;5;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;15;-623.9304,-53.19321;Inherit;False;Multiply;True;3;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.WorldPosInputsNode;19;-2144.224,-32.32907;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TriplanarNode;20;-1423.691,289.1413;Inherit;True;Spherical;World;True;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DAB76CCFD78C685D8080BD7E33BC4A2B467C20C2