...
Shader "Universal Render Pipeline/Terrain/ProceduralTerrainFirstPass"
{
	Properties
	{
		...
		[ASEBegin]_Specular2("Specular2", Color) = (0,0,0,0)
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 localCalculateTangentsSRP76_g13 = ( ( v.ase_tangent.xyz * v.ase_normal * 0.0 ) );
				{
				v.ase_tangent.xyz = cross ( v.ase_normal, float3( 0, 0, 1 ) );
				v.ase_tangent.w = -1;
				}
				float3 TangetsAlpha72 = localCalculateTangentsSRP76_g13;
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode5_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, uv_Control );
				...
				float4 weightedBlendVar295_g13 = float4(1,1,1,1);
				float4 weightedBlend295_g13 = ( weightedBlendVar295_g13.x*( (SplatControl26_g13).r * _Specular0 ) + weightedBlendVar295_g13.y*( (SplatControl26_g13).g * _Specular1 ) + weightedBlendVar295_g13.z*( (SplatControl26_g13).b * _Specular2 ) + weightedBlendVar295_g13.w*( (SplatControl26_g13).a * _Specular3 ) );
				float4 break528 = weightedBlend295_g13;
				...
				float4 tex2DNode4_g13 = SAMPLE_TEXTURE2D( _Splat0, sampler_linear_repeat_aniso4, uv_Splat0 );
				float4 appendResult258_g13 = (float4(( (SplatControl26_g13).rrr * (_DiffuseRemapScale0).rgb ) , 1.0));
				float4 tintLayer0253_g13 = appendResult258_g13;
				...
				float4 tex2DNode3_g13 = SAMPLE_TEXTURE2D( _Splat1, sampler_linear_repeat_aniso4, uv_Splat1 );
				float4 appendResult261_g13 = (float4(( (SplatControl26_g13).ggg * (_DiffuseRemapScale1).rgb ) , 1.0));
				float4 tintLayer1254_g13 = appendResult261_g13;
				...
				float4 tex2DNode6_g13 = SAMPLE_TEXTURE2D( _Splat2, sampler_linear_repeat_aniso4, uv_Splat2 );
				float4 appendResult263_g13 = (float4(( (SplatControl26_g13).bbb * (_DiffuseRemapScale2).rgb ) , 1.0));
				float4 tintLayer2255_g13 = appendResult263_g13;
				...
				float4 tex2DNode7_g13 = SAMPLE_TEXTURE2D( _Splat3, sampler_linear_repeat_aniso4, uv_Splat3 );
				float4 appendResult265_g13 = (float4(( (SplatControl26_g13).aaa * (_DiffuseRemapScale3).rgb ) , 1.0));
				float4 tintLayer3256_g13 = appendResult265_g13;
				float4 weightedBlendVar9_g13 = float4(1,1,1,1);
				float4 weightedBlend9_g13 = ( weightedBlendVar9_g13.x*( appendResult33_g13 * tex2DNode4_g13 * tintLayer0253_g13 ) + weightedBlendVar9_g13.y*( appendResult36_g13 * tex2DNode3_g13 * tintLayer1254_g13 ) + weightedBlendVar9_g13.z*( appendResult39_g13 * tex2DNode6_g13 * tintLayer2255_g13 ) + weightedBlendVar9_g13.w*( appendResult42_g13 * tex2DNode7_g13 * tintLayer3256_g13 ) );
				...
				float holeClipValue99_g13 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture ).r;
				...
				float4 AlbedoLayer67 = ( break528.g * localClipHoles100_g13 );
				...
				float FirstLayerControl66 = temp_output_59_0_g13.x;
				...
				float4 weightedBlend8_g13 = ( weightedBlendVar8_g13.x*SAMPLE_TEXTURE2D( _Normal0, sampler_linear_repeat_aniso4, uv_Splat0 ) + weightedBlendVar8_g13.y*SAMPLE_TEXTURE2D( _Normal1, sampler_linear_repeat_aniso4, uv_Splat1 ) + weightedBlendVar8_g13.z*SAMPLE_TEXTURE2D( _Normal2, sampler_linear_repeat_aniso4, uv_Splat2 ) + weightedBlendVar8_g13.w*SAMPLE_TEXTURE2D( _Normal3, sampler_linear_repeat_aniso4, uv_Splat3 ) );
				float3 temp_output_61_0_g13 = UnpackNormalScale( weightedBlend8_g13, 1.0 );
				float3 NormalLayer68 = temp_output_61_0_g13;
				...
				float4 appendResult205_g13 = (float4(_Smoothness0 , _Smoothness1 , _Smoothness2 , _Smoothness3));
				float4 appendResult206_g13 = (float4(tex2DNode4_g13.a , tex2DNode3_g13.a , tex2DNode6_g13.a , tex2DNode7_g13.a));
				float4 defaultSmoothness210_g13 = ( appendResult205_g13 * appendResult206_g13 );
				float localComputeMasks130_g13 = ( 0.0 );
				float4 masks0130_g13 = float4( 0,0,0,0 );
				float4 masks1130_g13 = float4( 0,0,0,0 );
				float4 masks2130_g13 = float4( 0,0,0,0 );
				float4 masks3130_g13 = float4( 0,0,0,0 );
				float4 appendResult135_g13 = (float4(_LayerHasMask0 , _LayerHasMask1 , _LayerHasMask2 , _LayerHasMask3));
				float4 layerHasMask136_g13 = appendResult135_g13;
				float4 hasMask130_g13 = layerHasMask136_g13;
				float2 uvMask0130_g13 = uv_Splat0;
				float2 uvMask1130_g13 = uv_Splat1;
				float2 uvMask2130_g13 = uv_Splat2;
				float2 uvMask3130_g13 = uv_Splat3;
				SamplerState SamplerS130_g13 = sampler_linear_repeat_aniso4;
				{
				masks0130_g13 = 0.5h;
				masks1130_g13 = 0.5h;
				masks2130_g13 = 0.5h;
				masks3130_g13 = 0.5h;
				#ifdef _MASKMAP
				masks0130_g13 = lerp(masks0130_g13, SAMPLE_TEXTURE2D(_Mask0, SamplerS130_g13, uvMask0130_g13), hasMask130_g13.x);
				masks1130_g13 = lerp(masks1130_g13, SAMPLE_TEXTURE2D(_Mask1, SamplerS130_g13, uvMask1130_g13), hasMask130_g13.y);
				masks2130_g13 = lerp(masks2130_g13, SAMPLE_TEXTURE2D(_Mask2, SamplerS130_g13, uvMask2130_g13), hasMask130_g13.z);
				masks3130_g13 = lerp(masks3130_g13, SAMPLE_TEXTURE2D(_Mask3, SamplerS130_g13, uvMask3130_g13), hasMask130_g13.w);
				#endif
				masks0130_g13 *= _MaskMapRemapScale0.rgba;
				masks0130_g13 += _MaskMapRemapOffset0.rgba;
				masks1130_g13 *= _MaskMapRemapScale1.rgba;
				masks1130_g13 += _MaskMapRemapOffset1.rgba;
				masks2130_g13 *= _MaskMapRemapScale2.rgba;
				masks2130_g13 += _MaskMapRemapOffset2.rgba;
				masks3130_g13 *= _MaskMapRemapScale3.rgba;
				masks3130_g13 += _MaskMapRemapOffset3.rgba;
				}
				float4 mask0138_g13 = masks0130_g13;
				float4 mask1139_g13 = masks1130_g13;
				float4 mask2140_g13 = masks2130_g13;
				float4 mask3141_g13 = masks3130_g13;
				float4 appendResult158_g13 = (float4((mask0138_g13).w , (mask1139_g13).w , (mask2140_g13).w , (mask3141_g13).w));
				float4 maskSmoothness149_g13 = appendResult158_g13;
				float4 lerpResult215_g13 = lerp( defaultSmoothness210_g13 , maskSmoothness149_g13 , layerHasMask136_g13);
				float dotResult216_g13 = dot( lerpResult215_g13 , SplatControl26_g13 );
				float mLayerSmootness515 = ( dotResult216_g13 * break528.r );
				float TriSmoothness428 = lerpResult413.a;
				float lerpResult90 = lerp( mLayerSmootness515 , TriSmoothness428 , FirstLayerControl66);
				
				float AlphaLayer71 = SplatWeight22_g13;
...
/*ASEBEGIN
Version=18935
0;73;1920;920;4030.046;41.84415;1;True;False
Node;AmplifyShaderEditor.FunctionNode;531;-3813.195,252.1583;Inherit;False;Four Splats First Pass Terrain;0;;13;37452fdfb732e1443b7e39720d05b708;2,85,0,102,1;7;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;201;FLOAT;0;False;62;FLOAT;0;False;9;COLOR;294;FLOAT4;274;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;19;FLOAT3;17
...
WireConnection;71;0;531;19
WireConnection;72;0;531;17
...
WireConnection;512;0;528;1
WireConnection;512;1;531;0
...
ASEEND*/
//CHKSM=FC45278F4C10119B645504452B2EE7C3ED38553D