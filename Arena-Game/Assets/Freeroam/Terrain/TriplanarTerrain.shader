...
Shader "TriplanarTerrain"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _AlbedoMid;
			sampler2D _AlbedoBottom;
			sampler2D _NormalTop;
			sampler2D _NormalMid;
			sampler2D _NormalBottom;
			sampler2D _SpecularTop;
			sampler2D _SpecularMid;
			sampler2D _SpecularBottom;
			...
			inline float3 TriplanarSampling13( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			inline float4 TriplanarSampling14( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar12 = TriplanarSampling12( _AlbedoTop, _AlbedoMid, _AlbedoBottom, WorldPosition, WorldNormal, _Falloff, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				
				float2 temp_cast_2 = (_Tiling).xx;
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar13 = TriplanarSampling13( _NormalTop, _NormalMid, _NormalBottom, WorldPosition, WorldNormal, _Falloff, temp_cast_2, float3( 1,1,1 ), float3(0,0,0) );
				float3 tanTriplanarNormal13 = mul( ase_worldToTangent, triplanar13 );
				
				float2 temp_cast_3 = (_Tiling).xx;
				float4 triplanar14 = TriplanarSampling14( _SpecularTop, _SpecularMid, _SpecularBottom, WorldPosition, WorldNormal, _Falloff, temp_cast_3, float3( 1,1,1 ), float3(0,0,0) );
				
				float3 Albedo = triplanar12.xyz;
				float3 Normal = tanTriplanarNormal13;
				float3 Emission = 0;
				float3 Specular = triplanar14.xyz;
				float Metallic = 0;
				float Smoothness = triplanar14.a;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar12 = TriplanarSampling12( _AlbedoTop, _AlbedoMid, _AlbedoBottom, WorldPosition, ase_worldNormal, _Falloff, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float3 triplanar13 = TriplanarSampling13( _NormalTop, _NormalMid, _NormalBottom, WorldPosition, WorldNormal, _Falloff, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				float3 tanTriplanarNormal13 = mul( ase_worldToTangent, triplanar13 );
...
/*ASEBEGIN
Version=18935
0;73;1920;920;4866.215;1495.901;2.895602;True;False
Node;AmplifyShaderEditor.TriplanarNode;12;-1378.828,-17.0256;Inherit;True;Cylindrical;World;False;Albedo Top;_AlbedoTop;white;0;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_grass_01_a_darker.tif;Albedo Mid;_AlbedoMid;white;1;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_a.tif;Albedo Bottom;_AlbedoBottom;white;2;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_a.tif;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;-3482.687,-134.7634;Inherit;False;Property;_Tile;Tile;8;0;Create;True;0;0;0;False;0;False;1;3.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-3127.688,-198.7633;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;44;-2611.653,-866.8756;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;43;-1549.601,-748.2448;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;42;-2883.12,-960.0798;Inherit;False;33;GlobalUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-2131.601,-675.2447;Inherit;False;Property;_NoiseAdd;NoiseAdd;14;0;Create;True;0;0;0;False;0;False;0;-0.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1900.601,-605.2447;Inherit;False;Property;_NoiseMul;NoiseMul;15;0;Create;True;0;0;0;False;0;False;1;1.35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;39;-1359.13,-810.5236;Inherit;False;MapNoise;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;37;-2219.67,-809.3527;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-2395.671,-654.3526;Inherit;False;Property;_NoiseConstrast;NoiseConstrast;12;0;Create;True;0;0;0;False;0;False;1;2.22;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-1741.601,-751.2446;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-1949.601,-808.2448;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-3124.469,-738.2056;Inherit;False;Property;_NoiseScale;NoiseScale;10;0;Create;True;0;0;0;False;0;False;10;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;33;-2895.688,-194.7633;Inherit;False;GlobalUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TriplanarNode;13;-1375.026,236.8359;Inherit;True;Cylindrical;World;True;Normal Top;_NormalTop;white;3;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_grass_01_n.tif;Normal Mid;_NormalMid;white;5;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_n.tif;Normal Bottom;_NormalBottom;white;7;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_n.tif;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;14;-1341.046,553.5323;Inherit;True;Cylindrical;World;False;Specular Top;_SpecularTop;white;4;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_grass_01_sg.tif;Specular Mid;_SpecularMid;white;6;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_sg.tif;Specular Bottom;_SpecularBottom;white;9;Assets/Freeroam/Viking Village/Textures/Terrain/terrain_mudslide_01_sg.tif;Specular Tri;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1683.027,145.8358;Inherit;False;Property;_Falloff;Falloff;13;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1710.027,44.83589;Inherit;False;Property;_Tiling;Tiling;11;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;46;-3448.464,-316.8724;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;300,46;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;TriplanarTerrain;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=27B778F3AFC2F696D0AA25618F5B056909577F90