	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float cos47 = cos( _RotateUV );
				float sin47 = sin( _RotateUV );
				float2 rotator47 = mul( ( _Tiling * appendResult34 ).xy - float2( 0,0 ) , float2x2( cos47 , -sin47 , sin47 , cos47 )) + float2( 0,0 );
				float2 ScaledUV35 = rotator47;
				
				float4 tex2DNode40 = tex2D( _Mask, ScaledUV35 );
				
				float3 Albedo = ( _Tint * tex2D( _Albedo, ScaledUV35 ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;73;1920;920;2345.555;407.584;1;True;False
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;35;-1142.465,-147.5172;Inherit;False;ScaledUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RotatorNode;47;-1362.105,-101.173;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-2051.718,-50.22828;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1905.363,-224.4512;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-1594.718,-155.2283;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-1524.004,8.004883;Inherit;False;Property;_RotateUV;RotateUV;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6EC53DBACCFC1DD83F6D492778C45880008D7E56