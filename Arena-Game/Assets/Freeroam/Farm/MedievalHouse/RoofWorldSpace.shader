	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 ScaledUV35 = ( _Tiling * appendResult34 );
				
				float4 tex2DNode40 = tex2D( _Mask, ScaledUV35.xy );
				
				float3 Albedo = ( _Tint * tex2D( _Albedo, ScaledUV35.xy ) ).rgb;
...
/*ASEBEGIN
Version=18935
280;73;896;591;1342.273;74.44368;1.044571;True;False
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;35;-1396.465,-129.5172;Inherit;False;ScaledUV;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=FAFE5D273E7601DC52BE0CA5D1B57355BDE72633